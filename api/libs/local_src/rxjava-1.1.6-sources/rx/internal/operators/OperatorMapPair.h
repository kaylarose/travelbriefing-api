...
/*!
 @brief An <code>Operator</code> that pairs up items emitted by a source <code>Observable</code> with the sequence of items
 emitted by the <code>Observable</code> that is derived from each item by means of a selector, and emits the
...
/*!
 @brief Creates the function that generates a <code>Observable</code> based on an item emitted by another <code>Observable</code>.
 @param selector
 a function that accepts an item and returns an <code>Iterable</code> of corresponding items
 @return a function that converts an item emitted by the source <code>Observable</code> into an <code>Observable</code> that emits the items generated by <code>selector</code> operating on that item
 */
