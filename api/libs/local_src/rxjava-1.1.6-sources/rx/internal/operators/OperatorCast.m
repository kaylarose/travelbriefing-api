...
- (RxSubscriber *)callWithId:(RxSubscriber *)o {
  RxInternalOperatorsOperatorCast_CastSubscriber *parent = new_RxInternalOperatorsOperatorCast_CastSubscriber_initWithRxSubscriber_withIOSClass_(o, castClass_);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withIOSClass:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
