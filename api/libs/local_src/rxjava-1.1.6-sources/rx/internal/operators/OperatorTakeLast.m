...
- (RxSubscriber *)callWithId:(RxSubscriber *)subscriber {
  RxInternalOperatorsOperatorTakeLast_TakeLastSubscriber *parent = new_RxInternalOperatorsOperatorTakeLast_TakeLastSubscriber_initWithRxSubscriber_withInt_(subscriber, count_);
  [((RxSubscriber *) nil_chk(subscriber)) addWithRxSubscription:parent];
  [subscriber setProducerWithRxProducer:new_RxInternalOperatorsOperatorTakeLast_$1_initWithRxInternalOperatorsOperatorTakeLast_TakeLastSubscriber_(parent)];
  return parent;
}
...
void RxInternalOperatorsOperatorTakeLast_initWithInt_(RxInternalOperatorsOperatorTakeLast *self, jint count) {
  NSObject_init(self);
  if (count < 0) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(@"count cannot be negative");
  }
  self->count_ = count;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "callWithId:", "LNSObject;", 0x1, 7, 3, -1, 8, -1, -1 },
    { "requestMoreWithLong:", "V", 0x0, 9, 10, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "LRxSubscriber;I", "(Lrx/Subscriber<-TT;>;I)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "call", "(Ljava/lang/Object;)TT;", "requestMore", "J", "Lrx/Subscriber<-TT;>;", "requested", "Ljava/util/ArrayDeque<Ljava/lang/Object;>;", "Lrx/internal/operators/NotificationLite<TT;>;", "LRxInternalOperatorsOperatorTakeLast;", "<T:Ljava/lang/Object;>Lrx/Subscriber<TT;>;Lrx/functions/Func1<Ljava/lang/Object;TT;>;" };
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorTakeLast_TakeLastSubscriber = { "TakeLastSubscriber", "rx.internal.operators", ptrTable, methods, fields, 7, 0x18, 6, 5, 15, -1, -1, 16, -1 };
...
void RxInternalOperatorsOperatorTakeLast_TakeLastSubscriber_initWithRxSubscriber_withInt_(RxInternalOperatorsOperatorTakeLast_TakeLastSubscriber *self, RxSubscriber *actual, jint count) {
  ...
  self->actual_ = actual;
  self->count_ = count;
  self->requested_TakeLastSubscriber_ = new_JavaUtilConcurrentAtomicAtomicLong_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalOperatorsOperatorTakeLast_TakeLastSubscriber:", NULL, 0x0, -1, 2, -1, 3, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
