 ...
 */
inline RxInternalOperatorsNotificationLite *RxInternalOperatorsOperatorWindowWithObservableFactory_get_nl();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT RxInternalOperatorsNotificationLite *RxInternalOperatorsOperatorWindowWithObservableFactory_nl;
J2OBJC_STATIC_FIELD_OBJ_FINAL(RxInternalOperatorsOperatorWindowWithObservableFactory, nl, RxInternalOperatorsNotificationLite *)
...
J2OBJC_FIELD_SETTER(RxInternalOperatorsOperatorWindowWithObservableFactory_SourceSubscriber, ssub_, RxSubscriptionsSerialSubscription *)
...
FOUNDATION_EXPORT RxInternalOperatorsOperatorWindowWithObservableFactory_BoundarySubscriber *new_RxInternalOperatorsOperatorWindowWithObservableFactory_BoundarySubscriber_initWithRxSubscriber_withRxInternalOperatorsOperatorWindowWithObservableFactory_SourceSubscriber_(RxSubscriber *child, RxInternalOperatorsOperatorWindowWithObservableFactory_SourceSubscriber *sub) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT RxInternalOperatorsOperatorWindowWithObservableFactory_BoundarySubscriber *create_RxInternalOperatorsOperatorWindowWithObservableFactory_BoundarySubscriber_initWithRxSubscriber_withRxInternalOperatorsOperatorWindowWithObservableFactory_SourceSubscriber_(RxSubscriber *child, RxInternalOperatorsOperatorWindowWithObservableFactory_SourceSubscriber *sub);
