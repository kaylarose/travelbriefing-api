...
static RxInternalOperatorsOperatorMerge *RxInternalOperatorsOperatorMerge_HolderNoDelay_INSTANCE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(RxInternalOperatorsOperatorMerge_HolderNoDelay, INSTANCE, RxInternalOperatorsOperatorMerge *)

__attribute__((unused)) static void RxInternalOperatorsOperatorMerge_HolderNoDelay_init(RxInternalOperatorsOperatorMerge_HolderNoDelay *self);

__attribute__((unused)) static RxInternalOperatorsOperatorMerge_HolderNoDelay *new_RxInternalOperatorsOperatorMerge_HolderNoDelay_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorMerge_HolderNoDelay *create_RxInternalOperatorsOperatorMerge_HolderNoDelay_init();
...
static RxInternalOperatorsOperatorMerge *RxInternalOperatorsOperatorMerge_HolderDelayErrors_INSTANCE;
...
__attribute__((unused)) static void RxInternalOperatorsOperatorMerge_HolderDelayErrors_init(RxInternalOperatorsOperatorMerge_HolderDelayErrors *self);

__attribute__((unused)) static RxInternalOperatorsOperatorMerge_HolderDelayErrors *new_RxInternalOperatorsOperatorMerge_HolderDelayErrors_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorMerge_HolderDelayErrors *create_RxInternalOperatorsOperatorMerge_HolderDelayErrors_init();
...
- (RxSubscriber *)callWithId:(RxSubscriber *)child {
  RxInternalOperatorsOperatorMerge_MergeSubscriber *subscriber = new_RxInternalOperatorsOperatorMerge_MergeSubscriber_initWithRxSubscriber_withBoolean_withInt_(child, delayErrors_, maxConcurrent_);
  RxInternalOperatorsOperatorMerge_MergeProducer *producer = new_RxInternalOperatorsOperatorMerge_MergeProducer_initWithRxInternalOperatorsOperatorMerge_MergeSubscriber_(subscriber);
  subscriber->producer_MergeSubscriber_ = producer;
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "instanceWithBoolean:", "LRxInternalOperatorsOperatorMerge;", 0x9, 0, 1, -1, 2, -1, -1 },
    { "instanceWithBoolean:withInt:", "LRxInternalOperatorsOperatorMerge;", 0x9, 0, 3, -1, 4, -1, -1 },
    { "initWithBoolean:withInt:", NULL, 0x0, -1, 3, -1, -1, -1, -1 },
...
RxInternalOperatorsOperatorMerge *RxInternalOperatorsOperatorMerge_instanceWithBoolean_withInt_(jboolean delayErrors, jint maxConcurrent) {
  RxInternalOperatorsOperatorMerge_initialize();
  if (maxConcurrent <= 0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"maxConcurrent > 0 required but it was ", maxConcurrent));
  }
  if (maxConcurrent == JavaLangInteger_MAX_VALUE) {
    return RxInternalOperatorsOperatorMerge_instanceWithBoolean_(delayErrors);
  }
  return new_RxInternalOperatorsOperatorMerge_initWithBoolean_withInt_(delayErrors, maxConcurrent);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorMerge_HolderNoDelay = { "HolderNoDelay", "rx.internal.operators", ptrTable, methods, fields, 7, 0x1a, 1, 1, 2, -1, -1, -1, -1 };
  return &_RxInternalOperatorsOperatorMerge_HolderNoDelay;
}

+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorMerge_HolderNoDelay class]) {
    RxInternalOperatorsOperatorMerge_HolderNoDelay_INSTANCE = new_RxInternalOperatorsOperatorMerge_initWithBoolean_withInt_(false, JavaLangInteger_MAX_VALUE);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorMerge_HolderDelayErrors = { "HolderDelayErrors", "rx.internal.operators", ptrTable, methods, fields, 7, 0x1a, 1, 1, 2, -1, -1, -1, -1 };
...
+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorMerge_HolderDelayErrors class]) {
    RxInternalOperatorsOperatorMerge_HolderDelayErrors_INSTANCE = new_RxInternalOperatorsOperatorMerge_initWithBoolean_withInt_(true, JavaLangInteger_MAX_VALUE);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxInternalOperatorsOperatorMerge_MergeSubscriber:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "requestWithLong:", "V", 0x1, 2, 3, -1, -1, -1, -1 },
    { "producedWithInt:", "J", 0x1, 4, 5, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
+ (IOSObjectArray *)EMPTY {
  return RxInternalOperatorsOperatorMerge_MergeSubscriber_EMPTY;
}
  ...
  if (q == nil) {
    @synchronized(self) {
      ...
      if (q == nil) {
        ...
        (void) JreVolatileStrongAssign(&errors_, q);
      }
    }
  }
  return q;
...
- (RxSubscriptionsCompositeSubscription *)getOrCreateComposite {
  ...
  if (c == nil) {
    ...
    @synchronized(self) {
      ...
      if (c == nil) {
        c = new_RxSubscriptionsCompositeSubscription_init();
        (void) JreVolatileStrongAssign(&subscriptions_MergeSubscriber_, c);
        shouldAdd = true;
      }
    }
    if (shouldAdd) {
...
- (void)onNextWithId:(RxObservable *)t {
  ...
  if (t == (id) RxObservable_empty()) {
    ...
    RxInternalOperatorsOperatorMerge_InnerSubscriber *inner = new_RxInternalOperatorsOperatorMerge_InnerSubscriber_initWithRxInternalOperatorsOperatorMerge_MergeSubscriber_withLong_(self, uniqueId_++);
    [self addInnerWithRxInternalOperatorsOperatorMerge_InnerSubscriber:inner];
    (void) [t unsafeSubscribeWithRxSubscriber:inner];
    [self emit];
  }
}
...
- (void)addInnerWithRxInternalOperatorsOperatorMerge_InnerSubscriber:(RxInternalOperatorsOperatorMerge_InnerSubscriber *)inner {
  ...
  @synchronized(innerGuard_) {
    ...
    IOSObjectArray *b = [IOSObjectArray newArrayWithLength:n + 1 type:RxInternalOperatorsOperatorMerge_InnerSubscriber_class_()];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(a, 0, b, 0, n);
    (void) IOSObjectArray_Set(b, n, inner);
    (void) JreVolatileStrongAssign(&innerSubscribers_, b);
  }
}
...
- (void)removeInnerWithRxInternalOperatorsOperatorMerge_InnerSubscriber:(RxInternalOperatorsOperatorMerge_InnerSubscriber *)inner {
  ...
  @synchronized(innerGuard_) {
    ...
    if (n == 1) {
      (void) JreVolatileStrongAssign(&innerSubscribers_, RxInternalOperatorsOperatorMerge_MergeSubscriber_EMPTY);
      return;
    }
    IOSObjectArray *b = [IOSObjectArray newArrayWithLength:n - 1 type:RxInternalOperatorsOperatorMerge_InnerSubscriber_class_()];
...
- (void)queueScalarWithRxInternalOperatorsOperatorMerge_InnerSubscriber:(RxInternalOperatorsOperatorMerge_InnerSubscriber *)subscriber
  ...
  if (q == nil) {
    ...
    (void) JreVolatileStrongAssign(&subscriber->queue_, q);
  }
  @try {
    [((RxInternalUtilRxRingBuffer *) nil_chk(q)) onNextWithId:[((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) nextWithId:value]];
  }
...
- (void)queueScalarWithId:(id)value {
  ...
  if (q == nil) {
    ...
    if (mc == JavaLangInteger_MAX_VALUE) {
      q = new_RxInternalUtilAtomicSpscUnboundedAtomicArrayQueue_initWithInt_(JreLoadStatic(RxInternalUtilRxRingBuffer, SIZE));
    }
    else {
      if (RxInternalUtilUnsafePow2_isPowerOfTwoWithInt_(mc)) {
        if (RxInternalUtilUnsafeUnsafeAccess_isUnsafeAvailable()) {
          q = new_RxInternalUtilUnsafeSpscArrayQueue_initWithInt_(mc);
        }
        else {
          q = new_RxInternalUtilAtomicSpscAtomicArrayQueue_initWithInt_(mc);
        }
      }
      else {
        q = new_RxInternalUtilAtomicSpscExactAtomicArrayQueue_initWithInt_(mc);
      }
    }
    (void) JreVolatileStrongAssign(&self->queue_, q);
  }
  if (![q offerWithId:[((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) nextWithId:value]]) {
    [self unsubscribe];
    [self onErrorWithNSException:RxExceptionsOnErrorThrowable_addValueAsLastCauseWithNSException_withId_(new_RxExceptionsMissingBackpressureException_init(), value)];
    return;
  }
  [self emit];
}
      ...
      if (svq != nil) {
        for (; ; ) {
          ...
          while (r > 0) {
            ...
            id v = [((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) getValueWithId:o];
            @try {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withBoolean:withInt:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "getOrCreateErrorQueue", "LJavaUtilQueue;", 0x0, -1, -1, -1, 2, -1, -1 },
    { "getOrCreateComposite", "LRxSubscriptionsCompositeSubscription;", 0x0, -1, -1, -1, -1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 3, 4, -1, 5, -1, -1 },
    { "emitEmpty", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "reportError", "V", 0x2, -1, -1, -1, -1, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 6, 7, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "addInnerWithRxInternalOperatorsOperatorMerge_InnerSubscriber:", "V", 0x0, 8, 9, -1, 10, -1, -1 },
    { "removeInnerWithRxInternalOperatorsOperatorMerge_InnerSubscriber:", "V", 0x0, 11, 9, -1, 10, -1, -1 },
    { "tryEmitWithRxInternalOperatorsOperatorMerge_InnerSubscriber:withId:", "V", 0x0, 12, 13, -1, 14, -1, -1 },
    { "queueScalarWithRxInternalOperatorsOperatorMerge_InnerSubscriber:withId:", "V", 0x4, 15, 13, -1, 14, -1, -1 },
    { "emitScalarWithRxInternalOperatorsOperatorMerge_InnerSubscriber:withId:withLong:", "V", 0x4, 16, 17, -1, 18, -1, -1 },
    { "requestMoreWithLong:", "V", 0x1, 19, 20, -1, -1, -1, -1 },
    { "tryEmitWithId:", "V", 0x0, 12, 21, -1, 22, -1, -1 },
    { "queueScalarWithId:", "V", 0x4, 15, 21, -1, 22, -1, -1 },
    { "emitScalarWithId:withLong:", "V", 0x4, 16, 23, -1, 24, -1, -1 },
    { "emit", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "emitLoop", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "checkTerminate", "Z", 0x0, -1, -1, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "nl_", "LRxInternalOperatorsNotificationLite;", .constantValue.asLong = 0, 0x10, -1, -1, 31, -1 },
    ...
    { "innerSubscribers_", "[LRxInternalOperatorsOperatorMerge_InnerSubscriber;", .constantValue.asLong = 0, 0x40, -1, -1, 32, -1 },
    ...
    { "EMPTY", "[LRxInternalOperatorsOperatorMerge_InnerSubscriber;", .constantValue.asLong = 0, 0x18, -1, 33, 32, -1 },
    { "scalarEmissionLimit_", "I", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "scalarEmissionCount_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LRxSubscriber;ZI", "(Lrx/Subscriber<-TT;>;ZI)V", "()Ljava/util/Queue<Ljava/lang/Throwable;>;", "onNext", "LRxObservable;", "(Lrx/Observable<+TT;>;)V", "onError", "LNSException;", "addInner", "LRxInternalOperatorsOperatorMerge_InnerSubscriber;", "(Lrx/internal/operators/OperatorMerge$InnerSubscriber<TT;>;)V", "removeInner", "tryEmit", "LRxInternalOperatorsOperatorMerge_InnerSubscriber;LNSObject;", "(Lrx/internal/operators/OperatorMerge$InnerSubscriber<TT;>;TT;)V", "queueScalar", "emitScalar", "LRxInternalOperatorsOperatorMerge_InnerSubscriber;LNSObject;J", "(Lrx/internal/operators/OperatorMerge$InnerSubscriber<TT;>;TT;J)V", "requestMore", "J", "LNSObject;", "(TT;)V", "LNSObject;J", "(TT;J)V", "Lrx/Subscriber<-TT;>;", "producer", "Lrx/internal/operators/OperatorMerge$MergeProducer<TT;>;", "Ljava/util/Queue<Ljava/lang/Object;>;", "subscriptions", "Ljava/util/concurrent/ConcurrentLinkedQueue<Ljava/lang/Throwable;>;", "Lrx/internal/operators/NotificationLite<TT;>;", "[Lrx/internal/operators/OperatorMerge$InnerSubscriber<*>;", &RxInternalOperatorsOperatorMerge_MergeSubscriber_EMPTY, "LRxInternalOperatorsOperatorMerge;", "<T:Ljava/lang/Object;>Lrx/Subscriber<Lrx/Observable<+TT;>;>;" };
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorMerge_MergeSubscriber = { "MergeSubscriber", "rx.internal.operators", ptrTable, methods, fields, 7, 0x18, 20, 19, 34, -1, -1, 35, -1 };
  return &_RxInternalOperatorsOperatorMerge_MergeSubscriber;
}

+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorMerge_MergeSubscriber class]) {
    RxInternalOperatorsOperatorMerge_MergeSubscriber_EMPTY = [IOSObjectArray newArrayWithLength:0 type:RxInternalOperatorsOperatorMerge_InnerSubscriber_class_()];
...
void RxInternalOperatorsOperatorMerge_MergeSubscriber_initWithRxSubscriber_withBoolean_withInt_(RxInternalOperatorsOperatorMerge_MergeSubscriber *self, RxSubscriber *child, jboolean delayErrors, jint maxConcurrent) {
  ...
  self->innerGuard_ = new_NSObject_init();
  (void) JreVolatileStrongAssign(&self->innerSubscribers_, RxInternalOperatorsOperatorMerge_MergeSubscriber_EMPTY);
  if (maxConcurrent == JavaLangInteger_MAX_VALUE) {
...
void RxInternalOperatorsOperatorMerge_MergeSubscriber_reportError(RxInternalOperatorsOperatorMerge_MergeSubscriber *self) {
  id<JavaUtilList> list = new_JavaUtilArrayList_initWithJavaUtilCollection_(JreLoadVolatileId(&self->errors_));
  if ([list size] == 1) {
    [((RxSubscriber *) nil_chk(self->child_)) onErrorWithNSException:[list getWithInt:0]];
  }
  else {
    [((RxSubscriber *) nil_chk(self->child_)) onErrorWithNSException:new_RxExceptionsCompositeException_initWithJavaUtilCollection_(list)];
  }
}
...
+ (jint)limit {
  return RxInternalOperatorsOperatorMerge_InnerSubscriber_limit;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxInternalOperatorsOperatorMerge_MergeSubscriber:withLong:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "onStart", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 2, 3, -1, 4, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 5, 6, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "requestMoreWithLong:", "V", 0x1, 7, 8, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
