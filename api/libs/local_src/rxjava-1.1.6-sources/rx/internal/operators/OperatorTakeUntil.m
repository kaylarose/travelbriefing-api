...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalOperatorsOperatorTakeUntil_$2)
...
- (RxSubscriber *)callWithId:(RxSubscriber *)child {
  ...
  RxSubscriber *main = new_RxInternalOperatorsOperatorTakeUntil_$1_initWithRxSubscriber_withRxSubscriber_withBoolean_(serial, serial, false);
  RxSubscriber *so = new_RxInternalOperatorsOperatorTakeUntil_$2_initWithRxSubscriber_(main);
  [serial addWithRxSubscription:main];
  [serial addWithRxSubscription:so];
  [((RxSubscriber *) nil_chk(child)) addWithRxSubscription:serial];
  (void) [((RxObservable *) nil_chk(other_)) unsafeSubscribeWithRxSubscriber:so];
  return main;
}
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalOperatorsOperatorTakeUntil_$2)
