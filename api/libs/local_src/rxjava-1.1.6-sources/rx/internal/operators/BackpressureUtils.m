...
__attribute__((unused)) static IOSObjectArray *RxInternalOperatorsBackpressureUtils__Annotations$0();

@implementation RxInternalOperatorsBackpressureUtils

+ (jlong)COMPLETED_MASK {
  return RxInternalOperatorsBackpressureUtils_COMPLETED_MASK;
}

+ (jlong)REQUESTED_MASK {
  return RxInternalOperatorsBackpressureUtils_REQUESTED_MASK;
}
...
+ (jlong)getAndAddRequestWithJavaUtilConcurrentAtomicAtomicLongFieldUpdater:(JavaUtilConcurrentAtomicAtomicLongFieldUpdater *)requested
                                                                     withId:(id)object
                                                                   withLong:(jlong)n {
  return RxInternalOperatorsBackpressureUtils_getAndAddRequestWithJavaUtilConcurrentAtomicAtomicLongFieldUpdater_withId_withLong_(requested, object, n);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "getAndAddRequestWithJavaUtilConcurrentAtomicAtomicLongFieldUpdater:withId:withLong:", "J", 0x9, 0, 1, -1, 2, 3, -1 },
    { "getAndAddRequestWithJavaUtilConcurrentAtomicAtomicLong:withLong:", "J", 0x9, 0, 4, -1, -1, -1, -1 },
    { "multiplyCapWithLong:withLong:", "J", 0x9, 5, 6, -1, -1, -1, -1 },
    { "addCapWithLong:withLong:", "J", 0x9, 7, 6, -1, -1, -1, -1 },
    { "postCompleteDoneWithJavaUtilConcurrentAtomicAtomicLong:withJavaUtilQueue:withRxSubscriber:", "V", 0x9, 8, 9, -1, 10, -1, -1 },
    { "postCompleteRequestWithJavaUtilConcurrentAtomicAtomicLong:withLong:withJavaUtilQueue:withRxSubscriber:", "Z", 0x9, 11, 12, -1, 13, -1, -1 },
    { "postCompleteDoneWithJavaUtilConcurrentAtomicAtomicLong:withJavaUtilQueue:withRxSubscriber:withRxFunctionsFunc1:", "V", 0x9, 8, 14, -1, 15, -1, -1 },
    { "postCompleteRequestWithJavaUtilConcurrentAtomicAtomicLong:withLong:withJavaUtilQueue:withRxSubscriber:withRxFunctionsFunc1:", "Z", 0x9, 11, 16, -1, 17, -1, -1 },
    { "postCompleteDrainWithJavaUtilConcurrentAtomicAtomicLong:withJavaUtilQueue:withRxSubscriber:withRxFunctionsFunc1:", "V", 0x8, 18, 14, -1, 15, -1, -1 },
    { "producedWithJavaUtilConcurrentAtomicAtomicLong:withLong:", "J", 0x9, 19, 4, -1, -1, -1, -1 },
  };
...
jlong RxInternalOperatorsBackpressureUtils_getAndAddRequestWithJavaUtilConcurrentAtomicAtomicLongFieldUpdater_withId_withLong_(JavaUtilConcurrentAtomicAtomicLongFieldUpdater *requested, id object, jlong n) {
  RxInternalOperatorsBackpressureUtils_initialize();
  while (true) {
    jlong current = [((JavaUtilConcurrentAtomicAtomicLongFieldUpdater *) nil_chk(requested)) getWithId:object];
    jlong next = RxInternalOperatorsBackpressureUtils_addCapWithLong_withLong_(current, n);
    if ([requested compareAndSetWithId:object withLong:current withLong:next]) {
      return current;
    }
  }
}
...
jlong RxInternalOperatorsBackpressureUtils_producedWithJavaUtilConcurrentAtomicAtomicLong_withLong_(JavaUtilConcurrentAtomicAtomicLong *requested, jlong n) {
  ...
  for (; ; ) {
    ...
    if (next < 0LL) {
      @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$J", @"More produced than requested: ", next));
    }
    if ([requested compareAndSetWithLong:current withLong:next]) {
      return next;
    }
...
IOSObjectArray *RxInternalOperatorsBackpressureUtils__Annotations$0() {
