...
- (void)callWithId:(RxSubscriber *)s {
  ...
  if (sources == nil) {
    if ([JavaUtilList_class_() isInstance:sourcesIterable_]) {
      ...
      sources = (IOSObjectArray *) cast_check([((id<JavaUtilList>) nil_chk(list)) toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[list size] type:RxObservable_class_()]], IOSClass_arrayType(RxObservable_class_(), 1));
      count = ((IOSObjectArray *) nil_chk(sources))->size_;
    }
    else {
      sources = [IOSObjectArray newArrayWithLength:8 type:RxObservable_class_()];
      for (RxObservable * __strong p in nil_chk(sourcesIterable_)) {
        if (count == sources->size_) {
          IOSObjectArray *b = [IOSObjectArray newArrayWithLength:count + (JreRShift32(count, 2)) type:RxObservable_class_()];
          JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(sources, 0, b, 0, count);
          sources = b;
        }
        (void) IOSObjectArray_Set(sources, count++, p);
      }
    }
  }
  else {
  ...
  RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator *lc = new_RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator_initWithRxSubscriber_withRxFunctionsFuncN_withInt_withInt_withBoolean_(s, combiner_, count, bufferSize_, delayError_);
  [lc subscribeWithRxObservableArray:sources];
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithJavaLangIterable:withRxFunctionsFuncN:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "initWithRxObservableArray:withJavaLangIterable:withRxFunctionsFuncN:withInt:withBoolean:", NULL, 0x1, -1, 2, -1, 3, -1, -1 },
...
void RxInternalOperatorsOnSubscribeCombineLatest_initWithRxObservableArray_withJavaLangIterable_withRxFunctionsFuncN_withInt_withBoolean_(RxInternalOperatorsOnSubscribeCombineLatest *self, IOSObjectArray *sources, id<JavaLangIterable> sourcesIterable, id<RxFunctionsFuncN> combiner, jint bufferSize, jboolean delayError) {
  ...
  self->sourcesIterable_ = sourcesIterable;
...
+ (id)MISSING {
  return RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator_MISSING;
}
...
- (void)subscribeWithRxObservableArray:(IOSObjectArray *)sources {
  ...
  for (jint i = 0; i < len; i++) {
    (void) IOSObjectArray_SetAndConsume(as, i, new_RxInternalOperatorsOnSubscribeCombineLatest_CombinerSubscriber_initWithRxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator_withInt_(self, i));
  }
  ...
  for (jint i = 0; i < len; i++) {
    ...
    (void) [((RxObservable *) nil_chk((IOSObjectArray_Get(nil_chk(sources), i)))) subscribeWithRxSubscriber:IOSObjectArray_Get(as, i)];
  }
}
...
- (void)combineWithId:(id)value
  ...
  @synchronized(self) {
    ...
    if (value == nil) {
      ...
      (void) IOSObjectArray_Set(latest_, index, [((RxInternalOperatorsNotificationLite *) nil_chk(((RxInternalOperatorsOnSubscribeCombineLatest_CombinerSubscriber *) nil_chk(combinerSubscriber))->nl_)) getValueWithId:value]);
    }
...
- (void)drain {
  ...
  for (; ; ) {
    ...
    jboolean unbounded = requestAmount == JavaLangLong_MAX_VALUE;
    jlong emitted = 0LL;
    while (requestAmount != 0LL) {
      ...
      if (array == nil) {
        ...
        [((RxSubscriber *) nil_chk(a)) onErrorWithNSException:new_JavaLangIllegalStateException_initWithNSString_(@"Broken queue?! Sender received but not the array.")];
        return;
      }
      id v;
      @try {
    ...
    if (emitted != 0LL) {
      if (!unbounded) {
        [localRequested addAndGetWithLong:emitted];
      }
    }
  ...
  for (; ; ) {
    ...
    if (curr != nil) {
      if ([curr isKindOfClass:[RxExceptionsCompositeException class]]) {
        ...
        id<JavaUtilList> es = new_JavaUtilArrayList_initWithJavaUtilCollection_([ce getExceptions]);
        [es addWithId:e];
        next = new_RxExceptionsCompositeException_initWithJavaUtilCollection_(es);
      }
      else {
        next = new_RxExceptionsCompositeException_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray newArrayWithObjects:(id[]){ curr, e } count:2 type:NSException_class_()]));
      }
    }
    else {
      next = e;
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withRxFunctionsFuncN:withInt:withInt:withBoolean:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "subscribeWithRxObservableArray:", "V", 0x1, 2, 3, -1, -1, -1, -1 },
    { "requestWithLong:", "V", 0x1, 4, 5, -1, -1, -1, -1 },
    { "unsubscribe", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "isUnsubscribed", "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { "cancelWithJavaUtilQueue:", "V", 0x0, 6, 7, -1, 8, -1, -1 },
    { "combineWithId:withInt:", "V", 0x0, 9, 10, -1, -1, -1, -1 },
    { "drain", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "checkTerminatedWithBoolean:withBoolean:withRxSubscriber:withJavaUtilQueue:withBoolean:", "Z", 0x0, 11, 12, -1, 13, -1, -1 },
    { "onErrorWithNSException:", "V", 0x0, 14, 15, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator = { "LatestCoordinator", "rx.internal.operators", ptrTable, methods, fields, 7, 0x18, 10, 16, 22, -1, -1, 23, -1 };
...
+ (void)initialize {
  if (self == [RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator class]) {
    RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator_MISSING = new_NSObject_init();
...
void RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator_initWithRxSubscriber_withRxFunctionsFuncN_withInt_withInt_withBoolean_(RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator *self, RxSubscriber *actual, id<RxFunctionsFuncN> combiner, jint count, jint bufferSize, jboolean delayError) {
  ...
  self->bufferSize_ = bufferSize;
  self->delayError_ = delayError;
  self->latest_ = [IOSObjectArray newArrayWithLength:count type:NSObject_class_()];
  ...
  self->subscribers_ = [IOSObjectArray newArrayWithLength:count type:RxInternalOperatorsOnSubscribeCombineLatest_CombinerSubscriber_class_()];
  self->queue_ = new_RxInternalUtilAtomicSpscLinkedArrayQueue_initWithInt_(bufferSize);
...
- (void)onNextWithId:(id)t {
  ...
  [((RxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator *) nil_chk(parent_)) combineWithId:[((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) nextWithId:t] withInt:index_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator:withInt:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "nl_", "LRxInternalOperatorsNotificationLite;", .constantValue.asLong = 0, 0x10, -1, -1, 10, -1 },
    { "done_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LRxInternalOperatorsOnSubscribeCombineLatest_LatestCoordinator;I", "(Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator<TT;TR;>;I)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "requestMore", "J", "Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator<TT;TR;>;", "Lrx/internal/operators/NotificationLite<TT;>;", "LRxInternalOperatorsOnSubscribeCombineLatest;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Lrx/Subscriber<TT;>;" };
  static const J2ObjcClassInfo _RxInternalOperatorsOnSubscribeCombineLatest_CombinerSubscriber = { "CombinerSubscriber", "rx.internal.operators", ptrTable, methods, fields, 7, 0x18, 5, 4, 11, -1, -1, 12, -1 };
