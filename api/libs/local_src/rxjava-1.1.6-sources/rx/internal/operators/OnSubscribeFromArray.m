...
- (void)callWithId:(RxSubscriber *)child {
  [((RxSubscriber *) nil_chk(child)) setProducerWithRxProducer:new_RxInternalOperatorsOnSubscribeFromArray_FromArrayProducer_initWithRxSubscriber_withNSObjectArray_(child, array_)];
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithNSObjectArray:", NULL, 0x1, -1, 0, -1, -1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withNSObjectArray:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
