...
static RxInternalOperatorsOperatorSwitch *RxInternalOperatorsOperatorSwitch_Holder_INSTANCE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(RxInternalOperatorsOperatorSwitch_Holder, INSTANCE, RxInternalOperatorsOperatorSwitch *)

__attribute__((unused)) static void RxInternalOperatorsOperatorSwitch_Holder_init(RxInternalOperatorsOperatorSwitch_Holder *self);

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_Holder *new_RxInternalOperatorsOperatorSwitch_Holder_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_Holder *create_RxInternalOperatorsOperatorSwitch_Holder_init();
...
static RxInternalOperatorsOperatorSwitch *RxInternalOperatorsOperatorSwitch_HolderDelayError_INSTANCE;
...
__attribute__((unused)) static void RxInternalOperatorsOperatorSwitch_HolderDelayError_init(RxInternalOperatorsOperatorSwitch_HolderDelayError *self);

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_HolderDelayError *new_RxInternalOperatorsOperatorSwitch_HolderDelayError_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_HolderDelayError *create_RxInternalOperatorsOperatorSwitch_HolderDelayError_init();
...
static NSException *RxInternalOperatorsOperatorSwitch_SwitchSubscriber_TERMINAL_ERROR;
J2OBJC_STATIC_FIELD_OBJ_FINAL(RxInternalOperatorsOperatorSwitch_SwitchSubscriber, TERMINAL_ERROR, NSException *)

__attribute__((unused)) static void RxInternalOperatorsOperatorSwitch_SwitchSubscriber_initWithRxSubscriber_withBoolean_(RxInternalOperatorsOperatorSwitch_SwitchSubscriber *self, RxSubscriber *child, jboolean delayError);

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_SwitchSubscriber *new_RxInternalOperatorsOperatorSwitch_SwitchSubscriber_initWithRxSubscriber_withBoolean_(RxSubscriber *child, jboolean delayError) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorSwitch_SwitchSubscriber *create_RxInternalOperatorsOperatorSwitch_SwitchSubscriber_initWithRxSubscriber_withBoolean_(RxSubscriber *child, jboolean delayError);
...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalOperatorsOperatorSwitch_SwitchSubscriber_$2)
...
- (RxSubscriber *)callWithId:(RxSubscriber *)child {
  RxInternalOperatorsOperatorSwitch_SwitchSubscriber *sws = new_RxInternalOperatorsOperatorSwitch_SwitchSubscriber_initWithRxSubscriber_withBoolean_(child, delayError_);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "instanceWithBoolean:", "LRxInternalOperatorsOperatorSwitch;", 0x9, 0, 1, -1, 2, -1, -1 },
    { "initWithBoolean:", NULL, 0x0, -1, 1, -1, -1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorSwitch_Holder = { "Holder", "rx.internal.operators", ptrTable, methods, fields, 7, 0x1a, 1, 1, 2, -1, -1, -1, -1 };
  return &_RxInternalOperatorsOperatorSwitch_Holder;
}

+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorSwitch_Holder class]) {
    RxInternalOperatorsOperatorSwitch_Holder_INSTANCE = new_RxInternalOperatorsOperatorSwitch_initWithBoolean_(false);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorSwitch_HolderDelayError = { "HolderDelayError", "rx.internal.operators", ptrTable, methods, fields, 7, 0x1a, 1, 1, 2, -1, -1, -1, -1 };
...
+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorSwitch_HolderDelayError class]) {
    RxInternalOperatorsOperatorSwitch_HolderDelayError_INSTANCE = new_RxInternalOperatorsOperatorSwitch_initWithBoolean_(true);
...
- (void)init__ {
  [((RxSubscriber *) nil_chk(child_)) addWithRxSubscription:ssub_];
  [child_ addWithRxSubscription:RxSubscriptionsSubscriptions_createWithRxFunctionsAction0_(new_RxInternalOperatorsOperatorSwitch_SwitchSubscriber_$1_initWithRxInternalOperatorsOperatorSwitch_SwitchSubscriber_(self))];
  [child_ setProducerWithRxProducer:new_RxInternalOperatorsOperatorSwitch_SwitchSubscriber_$2_initWithRxInternalOperatorsOperatorSwitch_SwitchSubscriber_(self)];
}

- (void)clearProducer {
  @synchronized(self) {
    producer_SwitchSubscriber_ = nil;
  }
}

- (void)onNextWithId:(RxObservable *)t {
  jlong id_ = [((JavaUtilConcurrentAtomicAtomicLong *) nil_chk(index_)) incrementAndGet];
  id<RxSubscription> s = [((RxSubscriptionsSerialSubscription *) nil_chk(ssub_)) get];
  if (s != nil) {
    [s unsubscribe];
  }
  RxInternalOperatorsOperatorSwitch_InnerSubscriber *inner;
  @synchronized(self) {
    inner = new_RxInternalOperatorsOperatorSwitch_InnerSubscriber_initWithLong_withRxInternalOperatorsOperatorSwitch_SwitchSubscriber_(id_, self);
    innerActive_ = true;
    producer_SwitchSubscriber_ = nil;
  }
  [ssub_ setWithRxSubscription:inner];
  (void) [((RxObservable *) nil_chk(t)) unsafeSubscribeWithRxSubscriber:inner];
}
...
- (jboolean)updateErrorWithNSException:(NSException *)next {
  ...
  if (e == RxInternalOperatorsOperatorSwitch_SwitchSubscriber_TERMINAL_ERROR) {
    ...
    id<JavaUtilList> list = new_JavaUtilArrayList_initWithJavaUtilCollection_([((RxExceptionsCompositeException *) cast_chk(e, [RxExceptionsCompositeException class])) getExceptions]);
    [list addWithId:next];
    error_ = new_RxExceptionsCompositeException_initWithJavaUtilCollection_(list);
  }
  else {
    error_ = new_RxExceptionsCompositeException_initWithNSExceptionArray_([IOSObjectArray newArrayWithObjects:(id[]){ e, next } count:2 type:NSException_class_()]);
  }
  return true;
}
...
withRxInternalOperatorsOperatorSwitch_InnerSubscriber:(RxInternalOperatorsOperatorSwitch_InnerSubscriber *)inner {
  @synchronized(self) {
    ...
    [((RxInternalUtilAtomicSpscLinkedArrayQueue *) nil_chk(queue_)) offerWithId:inner withId:[((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) nextWithId:value]];
  }
  [self drain];
}
...
- (void)drain {
  ...
  @synchronized(self) {
    ...
    if (localError != nil && localError != RxInternalOperatorsOperatorSwitch_SwitchSubscriber_TERMINAL_ERROR && !delayError_) {
      error_ = RxInternalOperatorsOperatorSwitch_SwitchSubscriber_TERMINAL_ERROR;
    }
  }
  ...
  for (; ; ) {
    ...
    while (localEmission != localRequested) {
      ...
      id value = [((RxInternalOperatorsNotificationLite *) nil_chk(nl_)) getValueWithId:[localQueue poll]];
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withBoolean:", NULL, 0x0, -1, 0, -1, 1, -1, -1 },
    { "init__", "V", 0x0, 2, -1, -1, -1, -1, -1 },
    { "clearProducer", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 3, 4, -1, 5, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 6, 7, -1, -1, -1, -1 },
    { "updateErrorWithNSException:", "Z", 0x0, 8, 7, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "emitWithId:withRxInternalOperatorsOperatorSwitch_InnerSubscriber:", "V", 0x0, 9, 10, -1, 11, -1, -1 },
    { "errorWithNSException:withLong:", "V", 0x0, 12, 13, -1, -1, -1, -1 },
    { "completeWithLong:", "V", 0x0, 14, 15, -1, -1, -1, -1 },
    { "pluginErrorWithNSException:", "V", 0x0, 16, 7, -1, -1, -1, -1 },
    { "innerProducerWithRxProducer:withLong:", "V", 0x0, 17, 18, -1, -1, -1, -1 },
    { "childRequestedWithLong:", "V", 0x0, 19, 15, -1, -1, -1, -1 },
    { "drain", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "checkTerminatedWithBoolean:withBoolean:withNSException:withRxInternalUtilAtomicSpscLinkedArrayQueue:withRxSubscriber:withBoolean:", "Z", 0x4, 20, 21, -1, 22, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "nl_", "LRxInternalOperatorsNotificationLite;", .constantValue.asLong = 0, 0x10, -1, -1, 25, -1 },
    { "emitting_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "missed_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "requested_SwitchSubscriber_", "J", .constantValue.asLong = 0, 0x0, 26, -1, -1, -1 },
    { "producer_SwitchSubscriber_", "LRxProducer;", .constantValue.asLong = 0, 0x0, 27, -1, -1, -1 },
...
+ (void)initialize {
  if (self == [RxInternalOperatorsOperatorSwitch_SwitchSubscriber class]) {
    RxInternalOperatorsOperatorSwitch_SwitchSubscriber_TERMINAL_ERROR = new_NSException_initWithNSString_(@"Terminal error");
...
void RxInternalOperatorsOperatorSwitch_SwitchSubscriber_initWithRxSubscriber_withBoolean_(RxInternalOperatorsOperatorSwitch_SwitchSubscriber *self, RxSubscriber *child, jboolean delayError) {
  ...
  self->delayError_ = delayError;
  self->index_ = new_JavaUtilConcurrentAtomicAtomicLong_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalOperatorsOperatorSwitch_SwitchSubscriber:", NULL, 0x0, -1, 0, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
- (void)requestWithLong:(jlong)n {
  if (n > 0LL) {
    ...
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$J", @"n >= 0 expected but it was ", n));
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalOperatorsOperatorSwitch_SwitchSubscriber:", NULL, 0x0, -1, 2, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LRxInternalOperatorsOperatorSwitch_SwitchSubscriber;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalOperatorsOperatorSwitch_SwitchSubscriber_$2)
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithLong:withRxInternalOperatorsOperatorSwitch_SwitchSubscriber:", NULL, 0x0, -1, 0, -1, 1, -1, -1 },
