...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "toIteratorWithRxObservable:", "LJavaUtilIterator;", 0x9, 0, 1, -1, 2, -1, -1 },
  };
...
id<JavaUtilIterator> RxInternalOperatorsBlockingOperatorToIterator_toIteratorWithRxObservable_(RxObservable *source) {
  ...
  RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator *subscriber = new_RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator_init();
  (void) [((RxObservable *) nil_chk([((RxObservable *) nil_chk((source))) materialize])) subscribeWithRxSubscriber:subscriber];
  return subscriber;
}
...
+ (jint)LIMIT {
  return RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator_LIMIT;
}
...
- (jboolean)hasNext {
  if (buf_ == nil) {
    buf_ = RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator_take(self);
    received_++;
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "take", "LRxNotification;", 0x2, -1, -1, -1, 6, -1, -1 },
...
void RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator_init(RxInternalOperatorsBlockingOperatorToIterator_SubscriberIterator *self) {
  ...
  self->notifications_ = new_JavaUtilConcurrentLinkedBlockingQueue_init();
}
