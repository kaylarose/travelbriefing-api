...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalOperatorsOnSubscribeConcatMap_$1)

@implementation RxInternalOperatorsOnSubscribeConcatMap

+ (jint)IMMEDIATE {
  return RxInternalOperatorsOnSubscribeConcatMap_IMMEDIATE;
}

+ (jint)BOUNDARY {
  return RxInternalOperatorsOnSubscribeConcatMap_BOUNDARY;
}

+ (jint)END {
  return RxInternalOperatorsOnSubscribeConcatMap_END;
}
...
- (void)callWithId:(RxSubscriber *)child {
  ...
  if (delayErrorMode_ == RxInternalOperatorsOnSubscribeConcatMap_IMMEDIATE) {
    s = new_RxObserversSerializedSubscriber_initWithRxSubscriber_(child);
  }
  else {
    s = child;
  }
  RxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber *parent = new_RxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withInt_withInt_(s, mapper_, prefetch_, delayErrorMode_);
  [((RxSubscriber *) nil_chk(child)) addWithRxSubscription:parent];
  [child addWithRxSubscription:parent->inner_];
  [child setProducerWithRxProducer:new_RxInternalOperatorsOnSubscribeConcatMap_$1_initWithRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber_(parent)];
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxObservable:withRxFunctionsFunc1:withInt:withInt:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
- (void)onNextWithId:(id)t {
  if (![((id<JavaUtilQueue>) nil_chk(queue_)) offerWithId:[((RxInternalOperatorsNotificationLite *) nil_chk(RxInternalOperatorsNotificationLite_instance())) nextWithId:t]]) {
    [self unsubscribe];
  ...
  for (; ; ) {
    ...
    if (!JreLoadVolatileBoolean(&active_)) {
      ...
      if (!empty) {
        RxObservable *source;
        @try {
          source = [((id<RxFunctionsFunc1>) nil_chk(mapper_)) callWithId:[((RxInternalOperatorsNotificationLite *) nil_chk(RxInternalOperatorsNotificationLite_instance())) getValueWithId:v]];
        }
        ...
        if (source == nil) {
          [self drainErrorWithNSException:new_JavaLangNullPointerException_initWithNSString_(@"The source returned by the mapper was null")];
          return;
        }
        if (source != (id) RxObservable_empty()) {
          if ([source isKindOfClass:[RxInternalUtilScalarSynchronousObservable class]]) {
            ...
            [((RxInternalProducersProducerArbiter *) nil_chk(arbiter_)) setProducerWithRxProducer:new_RxInternalOperatorsOnSubscribeConcatMap_ConcatMapInnerScalarProducer_initWithId_withRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber_([scalarSource get], self)];
          }
          else {
            RxInternalOperatorsOnSubscribeConcatMap_ConcatMapInnerSubscriber *innerSubscriber = new_RxInternalOperatorsOnSubscribeConcatMap_ConcatMapInnerSubscriber_initWithRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber_(self);
            [((RxSubscriptionsSerialSubscription *) nil_chk(inner_)) setWithRxSubscription:innerSubscriber];
            if (![innerSubscriber isUnsubscribed]) {
              JreAssignVolatileBoolean(&active_, true);
              (void) [source unsafeSubscribeWithRxSubscriber:innerSubscriber];
            }
            else {
              return;
            }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withRxFunctionsFunc1:withInt:withInt:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 2, 3, -1, 4, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 5, 6, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "requestMoreWithLong:", "V", 0x0, 7, 8, -1, -1, -1, -1 },
    { "innerNextWithId:", "V", 0x0, 9, 3, -1, 10, -1, -1 },
    { "innerErrorWithNSException:withLong:", "V", 0x0, 11, 12, -1, -1, -1, -1 },
    { "innerCompletedWithLong:", "V", 0x0, 13, 8, -1, -1, -1, -1 },
    { "pluginErrorWithNSException:", "V", 0x0, 14, 6, -1, -1, -1, -1 },
    { "drain", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "drainErrorWithNSException:", "V", 0x0, 15, 6, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
void RxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withInt_withInt_(RxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber *self, RxSubscriber *actual, id<RxFunctionsFunc1> mapper, jint prefetch, jint delayErrorMode) {
  ...
  self->mapper_ = mapper;
  self->delayErrorMode_ = delayErrorMode;
  self->arbiter_ = new_RxInternalProducersProducerArbiter_init();
  ...
  if (RxInternalUtilUnsafeUnsafeAccess_isUnsafeAvailable()) {
    q = new_RxInternalUtilUnsafeSpscArrayQueue_initWithInt_(prefetch);
  }
  else {
    q = new_RxInternalUtilAtomicSpscAtomicArrayQueue_initWithInt_(prefetch);
  }
  self->queue_ = q;
  self->inner_ = new_RxSubscriptionsSerialSubscription_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithId:withRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalOperatorsOnSubscribeConcatMap_ConcatMapSubscriber:", NULL, 0x0, -1, 2, -1, 3, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalOperatorsOnSubscribeConcatMap_$1)
