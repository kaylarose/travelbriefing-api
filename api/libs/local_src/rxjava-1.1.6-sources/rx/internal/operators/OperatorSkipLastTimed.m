...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "emitItemsOutOfWindowWithLong:", "V", 0x2, 0, 1, -1, -1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 2, 3, -1, 4, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 5, 6, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "initWithRxInternalOperatorsOperatorSkipLastTimed:withRxSubscriber:withRxSubscriber:", NULL, 0x0, -1, 7, -1, 8, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
void RxInternalOperatorsOperatorSkipLastTimed_$1_emitItemsOutOfWindowWithLong_(RxInternalOperatorsOperatorSkipLastTimed_$1 *self, jlong now) {
  ...
  while (![((id<JavaUtilDeque>) nil_chk(self->buffer_)) isEmpty]) {
    ...
    if ([((RxSchedulersTimestamped *) nil_chk(v)) getTimestampMillis] < limit) {
      (void) [((id<JavaUtilDeque>) nil_chk(self->buffer_)) removeFirst];
