...
- (void)callWithId:(id<RxCompletable_CompletableSubscriber>)s {
  RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber *parent = new_RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_initWithRxCompletable_CompletableSubscriber_withInt_(s, prefetch_);
  [((id<RxCompletable_CompletableSubscriber>) nil_chk(s)) onSubscribeWithRxSubscription:parent];
  (void) [((RxObservable *) nil_chk(sources_)) subscribeWithRxSubscriber:parent];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LRxObservable;I", "(Lrx/Observable<+Lrx/Completable;>;I)V", "call", "LRxCompletable_CompletableSubscriber;", "Lrx/Observable<Lrx/Completable;>;", "LRxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber;" };
...
- (instancetype)initWithRxCompletable_CompletableSubscriber:(id<RxCompletable_CompletableSubscriber>)actual
                                                    withInt:(jint)prefetch {
  RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_initWithRxCompletable_CompletableSubscriber_withInt_(self, actual, prefetch);
  return self;
}
...
- (void)onErrorWithNSException:(NSException *)t {
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(once_)) compareAndSetWithBoolean:false withBoolean:true]) {
    [((id<RxCompletable_CompletableSubscriber>) nil_chk(actual_)) onErrorWithNSException:t];
    return;
  }
...
- (void)next {
  ...
  if (c == nil) {
    ...
    [((RxPluginsRxJavaErrorHandler *) nil_chk([((RxPluginsRxJavaPlugins *) nil_chk(RxPluginsRxJavaPlugins_getInstance())) getErrorHandler])) handleErrorWithNSException:new_JavaLangIllegalStateException_initWithNSString_(@"Queue is empty?!")];
    return;
  }
  [c unsafeSubscribeWithRxCompletable_CompletableSubscriber:inner_];
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxCompletable_CompletableSubscriber:withInt:", NULL, 0x1, -1, 0, -1, -1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 1, 2, -1, -1, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 3, 4, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "innerErrorWithNSException:", "V", 0x0, 5, 4, -1, -1, -1, -1 },
    { "innerComplete", "V", 0x0, -1, -1, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LRxCompletable_CompletableSubscriber;I", "onNext", "LRxCompletable;", "onError", "LNSException;", "innerError", "Lrx/internal/util/unsafe/SpscArrayQueue<Lrx/Completable;>;", "LRxInternalOperatorsCompletableOnSubscribeConcat;", "LRxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_ConcatInnerSubscriber;", "Lrx/Subscriber<Lrx/Completable;>;" };
  static const J2ObjcClassInfo _RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber = { "CompletableConcatSubscriber", "rx.internal.operators", ptrTable, methods, fields, 7, 0x18, 7, 8, 7, 8, -1, 9, -1 };
  return &_RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber;
}

@end

void RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_initWithRxCompletable_CompletableSubscriber_withInt_(RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber *self, id<RxCompletable_CompletableSubscriber> actual, jint prefetch) {
  RxSubscriber_init(self);
  self->actual_ = actual;
  self->prefetch_ = prefetch;
  self->queue_ = new_RxInternalUtilUnsafeSpscArrayQueue_initWithInt_(prefetch);
  self->sr_ = new_RxSubscriptionsSerialSubscription_init();
  self->inner_ = new_RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_ConcatInnerSubscriber_initWithRxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_(self);
...
RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber *new_RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_initWithRxCompletable_CompletableSubscriber_withInt_(id<RxCompletable_CompletableSubscriber> actual, jint prefetch) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber, initWithRxCompletable_CompletableSubscriber_withInt_, actual, prefetch)
}

RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber *create_RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber_initWithRxCompletable_CompletableSubscriber_withInt_(id<RxCompletable_CompletableSubscriber> actual, jint prefetch) {
  J2OBJC_CREATE_IMPL(RxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber, initWithRxCompletable_CompletableSubscriber_withInt_, actual, prefetch)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "initWithRxInternalOperatorsCompletableOnSubscribeConcat_CompletableConcatSubscriber:", NULL, 0x0, -1, 4, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
