...
+ (IOSObjectArray *)EMPTY {
  return RxInternalOperatorsOnSubscribePublishMulticast_EMPTY;
}

+ (IOSObjectArray *)TERMINATED {
  return RxInternalOperatorsOnSubscribePublishMulticast_TERMINATED;
}
...
- (void)callWithId:(RxSubscriber *)t {
  RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer *pp = new_RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer_initWithRxSubscriber_withRxInternalOperatorsOnSubscribePublishMulticast_(t, self);
...
- (void)onNextWithId:(id)t {
  if (![((id<JavaUtilQueue>) nil_chk(queue_)) offerWithId:t]) {
    ...
    error_ = new_RxExceptionsMissingBackpressureException_initWithNSString_(@"Queue full?!");
...
- (void)setProducerWithRxProducer:(id<RxProducer>)p {
  (void) JreVolatileStrongAssign(&self->producer_, p);
...
- (IOSObjectArray *)terminate {
  ...
  if (a != RxInternalOperatorsOnSubscribePublishMulticast_TERMINATED) {
    @synchronized(self) {
      ...
      if (a != RxInternalOperatorsOnSubscribePublishMulticast_TERMINATED) {
        (void) JreVolatileStrongAssign(&subscribers_, RxInternalOperatorsOnSubscribePublishMulticast_TERMINATED);
      }
    }
  }
  return a;
...
- (jboolean)addWithRxInternalOperatorsOnSubscribePublishMulticast_PublishProducer:(RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer *)inner {
  ...
  @synchronized(self) {
    ...
    jint n = ((IOSObjectArray *) nil_chk(a))->size_;
    IOSObjectArray *b = [IOSObjectArray newArrayWithLength:n + 1 type:RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer_class_()];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(a, 0, b, 0, n);
    (void) IOSObjectArray_Set(b, n, inner);
    (void) JreVolatileStrongAssign(&subscribers_, b);
    return true;
  }
}
...
- (void)removeWithRxInternalOperatorsOnSubscribePublishMulticast_PublishProducer:(RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer *)inner {
  ...
  @synchronized(self) {
    ...
    if (n == 1) {
      ...
      b = [IOSObjectArray newArrayWithLength:n - 1 type:RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer_class_()];
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithInt:withBoolean:", NULL, 0x1, -1, 0, -1, -1, -1, -1 },
    { "callWithId:", "V", 0x1, 1, 2, -1, 3, -1, -1 },
    { "onNextWithId:", "V", 0x1, 4, 5, -1, 6, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 7, 8, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "setProducerWithRxProducer:", "V", 0x0, 9, 10, -1, -1, -1, -1 },
    { "drain", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "checkTerminatedWithBoolean:withBoolean:", "Z", 0x0, 11, 12, -1, -1, -1, -1 },
    { "terminate", "[LRxInternalOperatorsOnSubscribePublishMulticast_PublishProducer;", 0x0, -1, -1, -1, -1, -1, -1 },
    { "addWithRxInternalOperatorsOnSubscribePublishMulticast_PublishProducer:", "Z", 0x0, 13, 14, -1, 15, -1, -1 },
    { "removeWithRxInternalOperatorsOnSubscribePublishMulticast_PublishProducer:", "V", 0x0, 16, 14, -1, 17, -1, -1 },
    { "subscriber", "LRxSubscriber;", 0x1, -1, -1, -1, 18, -1, -1 },
...
+ (void)initialize {
  if (self == [RxInternalOperatorsOnSubscribePublishMulticast class]) {
    RxInternalOperatorsOnSubscribePublishMulticast_EMPTY = [IOSObjectArray newArrayWithLength:0 type:RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer_class_()];
    RxInternalOperatorsOnSubscribePublishMulticast_TERMINATED = [IOSObjectArray newArrayWithLength:0 type:RxInternalOperatorsOnSubscribePublishMulticast_PublishProducer_class_()];
...
void RxInternalOperatorsOnSubscribePublishMulticast_initWithInt_withBoolean_(RxInternalOperatorsOnSubscribePublishMulticast *self, jint prefetch, jboolean delayError) {
  ...
  (void) JreVolatileStrongAssign(&self->subscribers_, RxInternalOperatorsOnSubscribePublishMulticast_EMPTY);
  self->parent_ = new_RxInternalOperatorsOnSubscribePublishMulticast_ParentSubscriber_initWithRxInternalOperatorsOnSubscribePublishMulticast_(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxInternalOperatorsOnSubscribePublishMulticast:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withRxInternalOperatorsOnSubscribePublishMulticast:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
