...
@interface RxInternalOperatorsCompletableOnSubscribeConcatArray : NSObject < RxCompletable_CompletableOnSubscribe > {
 @public
...
@interface RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber : JavaUtilConcurrentAtomicAtomicInteger < RxCompletable_CompletableSubscriber > {
 @public
...
J2OBJC_FIELD_SETTER(RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber, actual_, id<RxCompletable_CompletableSubscriber>)
...
FOUNDATION_EXPORT void RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber_initWithRxCompletable_CompletableSubscriber_withRxCompletableArray_(RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber *self, id<RxCompletable_CompletableSubscriber> actual, IOSObjectArray *sources);

FOUNDATION_EXPORT RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber *new_RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber_initWithRxCompletable_CompletableSubscriber_withRxCompletableArray_(id<RxCompletable_CompletableSubscriber> actual, IOSObjectArray *sources) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber *create_RxInternalOperatorsCompletableOnSubscribeConcatArray_ConcatInnerSubscriber_initWithRxCompletable_CompletableSubscriber_withRxCompletableArray_(id<RxCompletable_CompletableSubscriber> actual, IOSObjectArray *sources);
