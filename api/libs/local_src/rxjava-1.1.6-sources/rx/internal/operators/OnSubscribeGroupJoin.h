...
/*!
 @brief Correlates two sequences when they overlap and groups the results.
 - seealso: <a href="http://msdn.microsoft.com/en-us/library/hh244235.aspx">MSDN: Observable.GroupJoin</a>
 */
...
/*!
 @brief Manages sub-observers and subscriptions.
 */
...
/*!
 @brief Notify everyone and cleanup.
 @param e the exception
 */
- (void)errorAllWithNSException:(NSException *)e;

/*!
 @brief Notify only the main subscriber and cleanup.
 @param e  the exception
 */
...
/*!
 @brief Observe the right source.
 */
...
/*!
 @brief Observe left duration and apply termination.
 */
...
/*!
 @brief Observe right duration and apply termination.
 */
...
/*!
 @brief The reference-counted window observable.
...
/*!
 @brief Observe activities on the window.
 */
