...
/*!
 @brief Returns an Observable that emits the last <code>count</code> items emitted by the source Observable.
 <p>
...
J2OBJC_FIELD_SETTER(RxInternalOperatorsOperatorTakeLastTimed_TakeLastTimedSubscriber, nl_, RxInternalOperatorsNotificationLite *)
