...
- (RxSubscriber *)callWithId:(RxSubscriber *)child {
  RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber *parent = new_RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withRxFunctionsFunc1_withRxFunctionsFunc0_(child, onNext_, onError_, onCompleted_);
  [((RxSubscriber *) nil_chk(child)) addWithRxSubscription:parent];
  [child setProducerWithRxProducer:new_RxInternalOperatorsOperatorMapNotification_$1_initWithRxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber_(parent)];
  return parent;
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxFunctionsFunc1:withRxFunctionsFunc1:withRxFunctionsFunc0:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
+ (jlong)COMPLETED_FLAG {
  return RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber_COMPLETED_FLAG;
}

+ (jlong)REQUESTED_MASK {
  return RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber_REQUESTED_MASK;
}
...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  @try {
    value_ = [((id<RxFunctionsFunc1>) nil_chk(onError_)) callWithId:e];
  }
  @catch (NSException *ex) {
...
- (void)onCompleted {
  [self accountProduced];
  @try {
    value_ = [((id<RxFunctionsFunc0>) nil_chk(onCompleted_)) call];
  }
  @catch (NSException *ex) {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withRxFunctionsFunc1:withRxFunctionsFunc1:withRxFunctionsFunc0:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "onNextWithId:", "V", 0x1, 2, 3, -1, 4, -1, -1 },
    { "onErrorWithNSException:", "V", 0x1, 5, 6, -1, -1, -1, -1 },
    { "onCompleted", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "accountProduced", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "setProducerWithRxProducer:", "V", 0x1, 7, 8, -1, -1, -1, -1 },
    { "tryEmit", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "requestInnerWithLong:", "V", 0x0, 9, 10, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
void RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withRxFunctionsFunc1_withRxFunctionsFunc0_(RxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber *self, RxSubscriber *actual, id<RxFunctionsFunc1> onNext, id<RxFunctionsFunc1> onError, id<RxFunctionsFunc0> onCompleted) {
  ...
  self->onError_ = onError;
  self->onCompleted_ = onCompleted;
  self->requested_MapNotificationSubscriber_ = new_JavaUtilConcurrentAtomicAtomicLong_init();
  self->missedRequested_ = new_JavaUtilConcurrentAtomicAtomicLong_init();
  self->producer_MapNotificationSubscriber_ = new_JavaUtilConcurrentAtomicAtomicReference_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalOperatorsOperatorMapNotification_MapNotificationSubscriber:", NULL, 0x0, -1, 2, -1, 3, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
