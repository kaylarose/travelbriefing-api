...
__attribute__((unused)) static RxInternalOperatorsEmptyObservableHolder *new_RxInternalOperatorsEmptyObservableHolder_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
+ (RxInternalOperatorsEmptyObservableHolder *)INSTANCE {
  return JreEnum(RxInternalOperatorsEmptyObservableHolder, INSTANCE);
}
...
- (RxInternalOperatorsEmptyObservableHolder_Enum)toNSEnum {
  return (RxInternalOperatorsEmptyObservableHolder_Enum)[self ordinal];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "values", "[LRxInternalOperatorsEmptyObservableHolder;", 0x9, -1, -1, -1, -1, -1, -1 },
    { "valueOfWithNSString:", "LRxInternalOperatorsEmptyObservableHolder;", 0x9, 4, 5, -1, -1, -1, -1 },
  };
...
+ (void)initialize {
  if (self == [RxInternalOperatorsEmptyObservableHolder class]) {
    JreEnum(RxInternalOperatorsEmptyObservableHolder, INSTANCE) = new_RxInternalOperatorsEmptyObservableHolder_initWithNSString_withInt_(@"INSTANCE", 0);
    RxInternalOperatorsEmptyObservableHolder_EMPTY = RxObservable_createWithRxObservable_OnSubscribe_(JreEnum(RxInternalOperatorsEmptyObservableHolder, INSTANCE));
...
RxInternalOperatorsEmptyObservableHolder *new_RxInternalOperatorsEmptyObservableHolder_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsEmptyObservableHolder, initWithNSString_withInt_, __name, __ordinal)
}
