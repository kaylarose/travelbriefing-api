...
#pragma push_macro("INCLUDE_ALL_RxInternalOperatorsOperatorSkipTimed")
#ifdef RESTRICT_RxInternalOperatorsOperatorSkipTimed
#define INCLUDE_ALL_RxInternalOperatorsOperatorSkipTimed 0
#else
#define INCLUDE_ALL_RxInternalOperatorsOperatorSkipTimed 1
#endif
#undef RESTRICT_RxInternalOperatorsOperatorSkipTimed

#if !defined (RxInternalOperatorsOperatorSkipTimed_) && (INCLUDE_ALL_RxInternalOperatorsOperatorSkipTimed || defined(INCLUDE_RxInternalOperatorsOperatorSkipTimed))
...
/*!
 @brief Skips elements until a specified time elapses.
 */
...
#pragma pop_macro("INCLUDE_ALL_RxInternalOperatorsOperatorSkipTimed")
