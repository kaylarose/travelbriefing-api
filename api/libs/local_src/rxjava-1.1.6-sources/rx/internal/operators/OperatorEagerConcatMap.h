...
@interface RxInternalOperatorsOperatorEagerConcatMap_EagerOuterSubscriber : RxSubscriber {
 @public
  ...
  JavaUtilLinkedList *subscribers_;
...
J2OBJC_FIELD_SETTER(RxInternalOperatorsOperatorEagerConcatMap_EagerOuterSubscriber, subscribers_, JavaUtilLinkedList *)
...
J2OBJC_FIELD_SETTER(RxInternalOperatorsOperatorEagerConcatMap_EagerInnerSubscriber, nl_, RxInternalOperatorsNotificationLite *)
