...
/*!
 @brief Groups the items emitted by an Observable according to a specified criterion, and emits these
...
FOUNDATION_EXPORT void RxInternalOperatorsOperatorGroupBy_initWithRxFunctionsFunc1_withRxFunctionsFunc1_withInt_withBoolean_(RxInternalOperatorsOperatorGroupBy *self, id<RxFunctionsFunc1> keySelector, id<RxFunctionsFunc1> valueSelector, jint bufferSize, jboolean delayError);

FOUNDATION_EXPORT RxInternalOperatorsOperatorGroupBy *new_RxInternalOperatorsOperatorGroupBy_initWithRxFunctionsFunc1_withRxFunctionsFunc1_withInt_withBoolean_(id<RxFunctionsFunc1> keySelector, id<RxFunctionsFunc1> valueSelector, jint bufferSize, jboolean delayError) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT RxInternalOperatorsOperatorGroupBy *create_RxInternalOperatorsOperatorGroupBy_initWithRxFunctionsFunc1_withRxFunctionsFunc1_withInt_withBoolean_(id<RxFunctionsFunc1> keySelector, id<RxFunctionsFunc1> valueSelector, jint bufferSize, jboolean delayError);
...
FOUNDATION_EXPORT RxInternalOperatorsOperatorGroupBy_GroupBySubscriber *new_RxInternalOperatorsOperatorGroupBy_GroupBySubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withRxFunctionsFunc1_withInt_withBoolean_(RxSubscriber *actual, id<RxFunctionsFunc1> keySelector, id<RxFunctionsFunc1> valueSelector, jint bufferSize, jboolean delayError) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT RxInternalOperatorsOperatorGroupBy_GroupBySubscriber *create_RxInternalOperatorsOperatorGroupBy_GroupBySubscriber_initWithRxSubscriber_withRxFunctionsFunc1_withRxFunctionsFunc1_withInt_withBoolean_(RxSubscriber *actual, id<RxFunctionsFunc1> keySelector, id<RxFunctionsFunc1> valueSelector, jint bufferSize, jboolean delayError);
