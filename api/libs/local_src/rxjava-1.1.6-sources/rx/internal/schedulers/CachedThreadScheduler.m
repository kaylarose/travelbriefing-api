...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$1)
...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$2)

@interface RxInternalSchedulersCachedThreadScheduler_EventLoopWorker : RxScheduler_Worker {
 @public
...
__attribute__((unused)) static void RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_(RxInternalSchedulersCachedThreadScheduler_EventLoopWorker *self, RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *pool);

__attribute__((unused)) static RxInternalSchedulersCachedThreadScheduler_EventLoopWorker *new_RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *pool) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalSchedulersCachedThreadScheduler_EventLoopWorker *create_RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *pool);
...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_$1)
...
+ (RxInternalSchedulersCachedThreadScheduler_ThreadWorker *)SHUTDOWN_THREADWORKER {
  return RxInternalSchedulersCachedThreadScheduler_SHUTDOWN_THREADWORKER;
}

+ (RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *)NONE {
  return RxInternalSchedulersCachedThreadScheduler_NONE;
}
...
- (void)start {
  RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *update = new_RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_initWithJavaUtilConcurrentThreadFactory_withLong_withJavaUtilConcurrentTimeUnit_(threadFactory_, RxInternalSchedulersCachedThreadScheduler_KEEP_ALIVE_TIME, RxInternalSchedulersCachedThreadScheduler_KEEP_ALIVE_UNIT);
...
- (RxScheduler_Worker *)createWorker {
  return new_RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_([((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(pool_)) get]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "pool_", "LJavaUtilConcurrentAtomicAtomicReference;", .constantValue.asLong = 0, 0x10, -1, -1, 3, -1 },
    { "NONE", "LRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool;", .constantValue.asLong = 0, 0x18, -1, 4, -1, -1 },
  };
  static const void *ptrTable[] = { "LJavaUtilConcurrentThreadFactory;", &RxInternalSchedulersCachedThreadScheduler_KEEP_ALIVE_UNIT, &RxInternalSchedulersCachedThreadScheduler_SHUTDOWN_THREADWORKER, "Ljava/util/concurrent/atomic/AtomicReference<Lrx/internal/schedulers/CachedThreadScheduler$CachedWorkerPool;>;", &RxInternalSchedulersCachedThreadScheduler_NONE, "LRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool;LRxInternalSchedulersCachedThreadScheduler_EventLoopWorker;LRxInternalSchedulersCachedThreadScheduler_ThreadWorker;" };
...
+ (void)initialize {
  if (self == [RxInternalSchedulersCachedThreadScheduler class]) {
    RxInternalSchedulersCachedThreadScheduler_KEEP_ALIVE_UNIT = JreLoadEnum(JavaUtilConcurrentTimeUnit, SECONDS);
    {
      RxInternalSchedulersCachedThreadScheduler_SHUTDOWN_THREADWORKER = new_RxInternalSchedulersCachedThreadScheduler_ThreadWorker_initWithJavaUtilConcurrentThreadFactory_(JreLoadStatic(RxInternalUtilRxThreadFactory, NONE));
      [RxInternalSchedulersCachedThreadScheduler_SHUTDOWN_THREADWORKER unsubscribe];
    }
    {
      RxInternalSchedulersCachedThreadScheduler_NONE = new_RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_initWithJavaUtilConcurrentThreadFactory_withLong_withJavaUtilConcurrentTimeUnit_(nil, 0, nil);
...
void RxInternalSchedulersCachedThreadScheduler_initWithJavaUtilConcurrentThreadFactory_(RxInternalSchedulersCachedThreadScheduler *self, id<JavaUtilConcurrentThreadFactory> threadFactory) {
  ...
  self->pool_ = new_JavaUtilConcurrentAtomicAtomicReference_initWithId_(RxInternalSchedulersCachedThreadScheduler_NONE);
  [self start];
}
...
- (RxInternalSchedulersCachedThreadScheduler_ThreadWorker *)get {
  ...
  RxInternalSchedulersCachedThreadScheduler_ThreadWorker *w = new_RxInternalSchedulersCachedThreadScheduler_ThreadWorker_initWithJavaUtilConcurrentThreadFactory_(threadFactory_);
...
- (void)shutdown {
  @try {
    ...
    if (evictorService_ != nil) {
      (void) [evictorService_ shutdownNow];
    }
  }
  @finally {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithJavaUtilConcurrentThreadFactory:withLong:withJavaUtilConcurrentTimeUnit:", NULL, 0x0, -1, 0, -1, -1, -1, -1 },
    { "get", "LRxInternalSchedulersCachedThreadScheduler_ThreadWorker;", 0x0, -1, -1, -1, -1, -1, -1 },
    { "release__WithRxInternalSchedulersCachedThreadScheduler_ThreadWorker:", "V", 0x0, 1, 2, -1, -1, -1, -1 },
    { "evictExpiredWorkers", "V", 0x0, -1, -1, -1, -1, -1, -1 },
    { "now", "J", 0x0, -1, -1, -1, -1, -1, -1 },
    { "shutdown", "V", 0x0, -1, -1, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const J2ObjcClassInfo _RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool = { "CachedWorkerPool", "rx.internal.schedulers", ptrTable, methods, fields, 7, 0x1a, 6, 6, 5, -1, -1, -1, -1 };
...
void RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_initWithJavaUtilConcurrentThreadFactory_withLong_withJavaUtilConcurrentTimeUnit_(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *self, id<JavaUtilConcurrentThreadFactory> threadFactory, jlong keepAliveTime, JavaUtilConcurrentTimeUnit *unit) {
  ...
  self->allWorkers_ = new_RxSubscriptionsCompositeSubscription_init();
  id<JavaUtilConcurrentScheduledExecutorService> evictor = nil;
  id<JavaUtilConcurrentFuture> task = nil;
  if (unit != nil) {
    evictor = JavaUtilConcurrentExecutors_newScheduledThreadPoolWithInt_withJavaUtilConcurrentThreadFactory_(1, new_RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$1_initWithJavaUtilConcurrentThreadFactory_(threadFactory));
    RxInternalSchedulersNewThreadWorker_tryEnableCancelPolicyWithJavaUtilConcurrentScheduledExecutorService_(evictor);
    task = [((id<JavaUtilConcurrentScheduledExecutorService>) nil_chk(evictor)) scheduleWithFixedDelayWithJavaLangRunnable:new_RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$2_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_(self) withLong:self->keepAliveTime_ withLong:self->keepAliveTime_ withJavaUtilConcurrentTimeUnit:JreLoadEnum(JavaUtilConcurrentTimeUnit, NANOSECONDS)];
  }
  self->evictorService_ = evictor;
  self->evictorTask_ = task;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithJavaUtilConcurrentThreadFactory:", NULL, 0x0, -1, 2, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
void RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$1_initWithJavaUtilConcurrentThreadFactory_(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$1 *self, id<JavaUtilConcurrentThreadFactory> capture$0) {
  self->val$threadFactory_ = capture$0;
  NSObject_init(self);
}
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$1)
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool:", NULL, 0x0, -1, 0, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_$2)
...
- (id<RxSubscription>)scheduleWithRxFunctionsAction0:(id<RxFunctionsAction0>)action
  ...
  RxInternalSchedulersScheduledAction *s = [((RxInternalSchedulersCachedThreadScheduler_ThreadWorker *) nil_chk(threadWorker_)) scheduleActualWithRxFunctionsAction0:new_RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_$1_initWithRxInternalSchedulersCachedThreadScheduler_EventLoopWorker_withRxFunctionsAction0_(self, action) withLong:delayTime withJavaUtilConcurrentTimeUnit:unit];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalSchedulersCachedThreadScheduler_EventLoopWorker = { "EventLoopWorker", "rx.internal.schedulers", ptrTable, methods, fields, 7, 0x1a, 5, 4, 4, -1, -1, -1, -1 };
...
void RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_initWithRxInternalSchedulersCachedThreadScheduler_CachedWorkerPool_(RxInternalSchedulersCachedThreadScheduler_EventLoopWorker *self, RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *pool) {
  ...
  self->threadWorker_ = [((RxInternalSchedulersCachedThreadScheduler_CachedWorkerPool *) nil_chk(pool)) get];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalSchedulersCachedThreadScheduler_EventLoopWorker:withRxFunctionsAction0:", NULL, 0x0, -1, 0, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalSchedulersCachedThreadScheduler_EventLoopWorker_$1)
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "getExpirationTime", "J", 0x1, -1, -1, -1, -1, -1, -1 },
    { "setExpirationTimeWithLong:", "V", 0x1, 1, 2, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const J2ObjcClassInfo _RxInternalSchedulersCachedThreadScheduler_ThreadWorker = { "ThreadWorker", "rx.internal.schedulers", ptrTable, methods, fields, 7, 0x1a, 3, 1, 3, -1, -1, -1, -1 };
