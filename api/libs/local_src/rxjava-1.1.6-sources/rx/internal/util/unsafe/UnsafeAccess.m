...
+ (SunMiscUnsafe *)UNSAFE {
  return RxInternalUtilUnsafeUnsafeAccess_UNSAFE;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "isUnsafeAvailable", "Z", 0x9, -1, -1, -1, -1, -1, -1 },
    { "getAndIncrementIntWithId:withLong:", "I", 0x9, 0, 1, -1, -1, -1, -1 },
    { "getAndAddIntWithId:withLong:withInt:", "I", 0x9, 2, 3, -1, -1, -1, -1 },
    { "getAndSetIntWithId:withLong:withInt:", "I", 0x9, 4, 3, -1, -1, -1, -1 },
    { "compareAndSwapIntWithId:withLong:withInt:withInt:", "Z", 0x9, 5, 6, -1, -1, -1, -1 },
    { "addressOfWithIOSClass:withNSString:", "J", 0x9, 7, 8, -1, 9, -1, -1 },
  };
...
jlong RxInternalUtilUnsafeUnsafeAccess_addressOfWithIOSClass_withNSString_(IOSClass *clazz, NSString *fieldName) {
  ...
  @catch (JavaLangNoSuchFieldException *ex) {
    JavaLangInternalError *ie = new_JavaLangInternalError_init();
    (void) [ie initCauseWithNSException:ex];
    @throw ie;
  }
}
