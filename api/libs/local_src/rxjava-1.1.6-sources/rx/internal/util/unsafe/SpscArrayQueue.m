...
+ (void)initialize {
  if (self == [RxInternalUtilUnsafeSpscArrayQueueColdField class]) {
    RxInternalUtilUnsafeSpscArrayQueueColdField_MAX_LOOK_AHEAD_STEP = JavaLangInteger_getIntegerWithNSString_withInt_(@"jctools.spsc.max.lookahead.step", 4096);
...
+ (jlong)P_INDEX_OFFSET {
  return RxInternalUtilUnsafeSpscArrayQueueProducerFields_P_INDEX_OFFSET;
}
...
+ (jlong)C_INDEX_OFFSET {
  return RxInternalUtilUnsafeSpscArrayQueueConsumerField_C_INDEX_OFFSET;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "soProducerIndexWithLong:", "V", 0x2, 5, 6, -1, -1, -1, -1 },
    { "soConsumerIndexWithLong:", "V", 0x2, 7, 6, -1, -1, -1, -1 },
