...
+ (jint)SPARSE_SHIFT {
  return RxInternalUtilUnsafeConcurrentCircularArrayQueue_SPARSE_SHIFT;
}

+ (jint)BUFFER_PAD {
  return RxInternalUtilUnsafeConcurrentCircularArrayQueue_BUFFER_PAD;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "calcElementOffsetWithLong:", "J", 0x14, 1, 2, -1, -1, -1, -1 },
    { "calcElementOffsetWithLong:withLong:", "J", 0x14, 1, 3, -1, -1, -1, -1 },
    { "spElementWithLong:withId:", "V", 0x14, 4, 5, -1, 6, -1, -1 },
    { "spElementWithNSObjectArray:withLong:withId:", "V", 0x14, 4, 7, -1, 8, -1, -1 },
    { "soElementWithLong:withId:", "V", 0x14, 9, 5, -1, 6, -1, -1 },
    { "soElementWithNSObjectArray:withLong:withId:", "V", 0x14, 9, 7, -1, 8, -1, -1 },
    { "lpElementWithLong:", "LNSObject;", 0x14, 10, 2, -1, 11, -1, -1 },
    { "lpElementWithNSObjectArray:withLong:", "LNSObject;", 0x14, 10, 12, -1, 13, -1, -1 },
    { "lvElementWithLong:", "LNSObject;", 0x14, 14, 2, -1, 11, -1, -1 },
    { "lvElementWithNSObjectArray:withLong:", "LNSObject;", 0x14, 14, 12, -1, 13, -1, -1 },
    { "iterator", "LJavaUtilIterator;", 0x1, -1, -1, -1, 15, -1, -1 },
...
void RxInternalUtilUnsafeConcurrentCircularArrayQueue_initWithInt_(RxInternalUtilUnsafeConcurrentCircularArrayQueue *self, jint capacity) {
  ...
  self->buffer_ = [IOSObjectArray newArrayWithLength:(JreLShift32(actualCapacity, RxInternalUtilUnsafeConcurrentCircularArrayQueue_SPARSE_SHIFT)) + RxInternalUtilUnsafeConcurrentCircularArrayQueue_BUFFER_PAD * 2 type:NSObject_class_()];
}
