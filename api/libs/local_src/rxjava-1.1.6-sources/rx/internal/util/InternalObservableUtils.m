...
//  source: build/libs_raw/rxjava-1.1.6-sources/rx/internal/util/InternalObservableUtils.java
//
...
__attribute__((unused)) static RxInternalUtilInternalObservableUtils *new_RxInternalUtilInternalObservableUtils_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
__attribute__((unused)) static void RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams_initWithRxObservable_(RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams *self, RxObservable *source);

__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams *new_RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams_initWithRxObservable_(RxObservable *source) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams *create_RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams_initWithRxObservable_(RxObservable *source);
...
__attribute__((unused)) static void RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer_initWithRxObservable_withInt_(RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer *self, RxObservable *source, jint bufferSize);

__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer *new_RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer_initWithRxObservable_withInt_(RxObservable *source, jint bufferSize) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer *create_RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer_initWithRxObservable_withInt_(RxObservable *source, jint bufferSize);
...
__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierTime *new_RxInternalUtilInternalObservableUtils_ReplaySupplierTime_initWithRxObservable_withInt_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(RxObservable *source, jint bufferSize, jlong time, JavaUtilConcurrentTimeUnit *unit, RxScheduler *scheduler) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalUtilInternalObservableUtils_ReplaySupplierTime *create_RxInternalUtilInternalObservableUtils_ReplaySupplierTime_initWithRxObservable_withInt_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(RxObservable *source, jint bufferSize, jlong time, JavaUtilConcurrentTimeUnit *unit, RxScheduler *scheduler);
...
+ (RxInternalUtilInternalObservableUtils_PlusOneFunc2 *)COUNTER {
  return RxInternalUtilInternalObservableUtils_COUNTER;
}

+ (RxInternalUtilInternalObservableUtils_PlusOneLongFunc2 *)LONG_COUNTER {
  return RxInternalUtilInternalObservableUtils_LONG_COUNTER;
}

+ (RxInternalUtilInternalObservableUtils_ObjectEqualsFunc2 *)OBJECT_EQUALS {
  return RxInternalUtilInternalObservableUtils_OBJECT_EQUALS;
}

+ (RxInternalUtilInternalObservableUtils_ToArrayFunc1 *)TO_ARRAY {
  return RxInternalUtilInternalObservableUtils_TO_ARRAY;
}

+ (RxInternalUtilInternalObservableUtils_ReturnsVoidFunc1 *)RETURNS_VOID {
  return RxInternalUtilInternalObservableUtils_RETURNS_VOID;
}

+ (RxInternalUtilInternalObservableUtils_NotificationErrorExtractor *)ERROR_EXTRACTOR {
  return RxInternalUtilInternalObservableUtils_ERROR_EXTRACTOR;
}

+ (id<RxFunctionsAction1>)ERROR_NOT_IMPLEMENTED {
  return RxInternalUtilInternalObservableUtils_ERROR_NOT_IMPLEMENTED;
}

+ (id<RxObservable_Operator>)IS_EMPTY {
  return RxInternalUtilInternalObservableUtils_IS_EMPTY;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "equalsWithWithId:", "LRxFunctionsFunc1;", 0x9, 0, 1, -1, 2, -1, -1 },
    { "isInstanceOfWithIOSClass:", "LRxFunctionsFunc1;", 0x9, 3, 4, -1, 5, -1, -1 },
    { "createRepeatDematerializerWithRxFunctionsFunc1:", "LRxFunctionsFunc1;", 0x19, 6, 7, -1, 8, -1, -1 },
    { "createReplaySelectorAndObserveOnWithRxFunctionsFunc1:withRxScheduler:", "LRxFunctionsFunc1;", 0x9, 9, 10, -1, 11, -1, -1 },
    { "createRetryDematerializerWithRxFunctionsFunc1:", "LRxFunctionsFunc1;", 0x19, 12, 7, -1, 13, -1, -1 },
    { "createReplaySupplierWithRxObservable:", "LRxFunctionsFunc0;", 0x9, 14, 15, -1, 16, -1, -1 },
    { "createReplaySupplierWithRxObservable:withInt:", "LRxFunctionsFunc0;", 0x9, 14, 17, -1, 18, -1, -1 },
    { "createReplaySupplierWithRxObservable:withLong:withJavaUtilConcurrentTimeUnit:withRxScheduler:", "LRxFunctionsFunc0;", 0x9, 14, 19, -1, 20, -1, -1 },
    { "createReplaySupplierWithRxObservable:withInt:withLong:withJavaUtilConcurrentTimeUnit:withRxScheduler:", "LRxFunctionsFunc0;", 0x9, 14, 21, -1, 22, -1, -1 },
    { "createCollectorCallerWithRxFunctionsAction2:", "LRxFunctionsFunc2;", 0x9, 23, 24, -1, 25, -1, -1 },
    { "values", "[LRxInternalUtilInternalObservableUtils;", 0x9, -1, -1, -1, -1, -1, -1 },
    { "valueOfWithNSString:", "LRxInternalUtilInternalObservableUtils;", 0x9, 26, 27, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "COUNTER", "LRxInternalUtilInternalObservableUtils_PlusOneFunc2;", .constantValue.asLong = 0, 0x19, -1, 28, -1, -1 },
    { "LONG_COUNTER", "LRxInternalUtilInternalObservableUtils_PlusOneLongFunc2;", .constantValue.asLong = 0, 0x19, -1, 29, -1, -1 },
    { "OBJECT_EQUALS", "LRxInternalUtilInternalObservableUtils_ObjectEqualsFunc2;", .constantValue.asLong = 0, 0x19, -1, 30, -1, -1 },
    { "TO_ARRAY", "LRxInternalUtilInternalObservableUtils_ToArrayFunc1;", .constantValue.asLong = 0, 0x19, -1, 31, -1, -1 },
    { "RETURNS_VOID", "LRxInternalUtilInternalObservableUtils_ReturnsVoidFunc1;", .constantValue.asLong = 0, 0x18, -1, 32, -1, -1 },
...
+ (void)initialize {
  if (self == [RxInternalUtilInternalObservableUtils class]) {
    RxInternalUtilInternalObservableUtils_COUNTER = new_RxInternalUtilInternalObservableUtils_PlusOneFunc2_init();
    RxInternalUtilInternalObservableUtils_LONG_COUNTER = new_RxInternalUtilInternalObservableUtils_PlusOneLongFunc2_init();
    RxInternalUtilInternalObservableUtils_OBJECT_EQUALS = new_RxInternalUtilInternalObservableUtils_ObjectEqualsFunc2_init();
    RxInternalUtilInternalObservableUtils_TO_ARRAY = new_RxInternalUtilInternalObservableUtils_ToArrayFunc1_init();
    RxInternalUtilInternalObservableUtils_RETURNS_VOID = new_RxInternalUtilInternalObservableUtils_ReturnsVoidFunc1_init();
    RxInternalUtilInternalObservableUtils_ERROR_EXTRACTOR = new_RxInternalUtilInternalObservableUtils_NotificationErrorExtractor_init();
    RxInternalUtilInternalObservableUtils_ERROR_NOT_IMPLEMENTED = new_RxInternalUtilInternalObservableUtils_ErrorNotImplementedAction_init();
    RxInternalUtilInternalObservableUtils_IS_EMPTY = new_RxInternalOperatorsOperatorAny_initWithRxFunctionsFunc1_withBoolean_(RxInternalUtilUtilityFunctions_alwaysTrue(), true);
...
id<RxFunctionsFunc1> RxInternalUtilInternalObservableUtils_equalsWithWithId_(id other) {
  ...
  return new_RxInternalUtilInternalObservableUtils_EqualsWithFunc1_initWithId_(other);
}

id<RxFunctionsFunc1> RxInternalUtilInternalObservableUtils_isInstanceOfWithIOSClass_(IOSClass *clazz) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_IsInstanceOfFunc1_initWithIOSClass_(clazz);
}
...
id<RxFunctionsFunc1> RxInternalUtilInternalObservableUtils_createRepeatDematerializerWithRxFunctionsFunc1_(id<RxFunctionsFunc1> notificationHandler) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_RepeatNotificationDematerializer_initWithRxFunctionsFunc1_(notificationHandler);
}
...
id<RxFunctionsFunc1> RxInternalUtilInternalObservableUtils_createReplaySelectorAndObserveOnWithRxFunctionsFunc1_withRxScheduler_(id<RxFunctionsFunc1> selector, RxScheduler *scheduler) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_SelectorAndObserveOn_initWithRxFunctionsFunc1_withRxScheduler_(selector, scheduler);
}
...
id<RxFunctionsFunc1> RxInternalUtilInternalObservableUtils_createRetryDematerializerWithRxFunctionsFunc1_(id<RxFunctionsFunc1> notificationHandler) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_RetryNotificationDematerializer_initWithRxFunctionsFunc1_(notificationHandler);
}

id<RxFunctionsFunc0> RxInternalUtilInternalObservableUtils_createReplaySupplierWithRxObservable_(RxObservable *source) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams_initWithRxObservable_(source);
}
...
id<RxFunctionsFunc0> RxInternalUtilInternalObservableUtils_createReplaySupplierWithRxObservable_withInt_(RxObservable *source, jint bufferSize) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_ReplaySupplierBuffer_initWithRxObservable_withInt_(source, bufferSize);
}
...
id<RxFunctionsFunc0> RxInternalUtilInternalObservableUtils_createReplaySupplierWithRxObservable_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(RxObservable *source, jlong time, JavaUtilConcurrentTimeUnit *unit, RxScheduler *scheduler) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_ReplaySupplierBufferTime_initWithRxObservable_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(source, time, unit, scheduler);
}
...
id<RxFunctionsFunc0> RxInternalUtilInternalObservableUtils_createReplaySupplierWithRxObservable_withInt_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(RxObservable *source, jint bufferSize, jlong time, JavaUtilConcurrentTimeUnit *unit, RxScheduler *scheduler) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_ReplaySupplierTime_initWithRxObservable_withInt_withLong_withJavaUtilConcurrentTimeUnit_withRxScheduler_(source, bufferSize, time, unit, scheduler);
}
...
id<RxFunctionsFunc2> RxInternalUtilInternalObservableUtils_createCollectorCallerWithRxFunctionsAction2_(id<RxFunctionsAction2> collector) {
  RxInternalUtilInternalObservableUtils_initialize();
  return new_RxInternalUtilInternalObservableUtils_CollectorCaller_initWithRxFunctionsAction2_(collector);
}
...
RxInternalUtilInternalObservableUtils *new_RxInternalUtilInternalObservableUtils_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(RxInternalUtilInternalObservableUtils, initWithNSString_withInt_, __name, __ordinal)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:withId:", "LJavaLangInteger;", 0x1, 0, 1, -1, -1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:withId:", "LJavaLangLong;", 0x1, 0, 1, -1, -1, -1, -1 },
    { "init", NULL, 0x0, -1, -1, -1, -1, -1, -1 },
  };
...
- (IOSObjectArray *)callWithId:(id<JavaUtilList>)o {
  return [((id<JavaUtilList>) nil_chk(o)) toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[o size] type:RxObservable_class_()]];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "callWithId:", "LJavaLangBoolean;", 0x1, 1, 0, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithIOSClass:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "callWithId:", "LJavaLangBoolean;", 0x1, 2, 3, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
void RxInternalUtilInternalObservableUtils_RepeatNotificationDematerializer_initWithRxFunctionsFunc1_(RxInternalUtilInternalObservableUtils_RepeatNotificationDematerializer *self, id<RxFunctionsFunc1> notificationHandler) {
  NSObject_init(self);
  self->notificationHandler_ = notificationHandler;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:", "LJavaLangVoid;", 0x1, 0, 1, -1, -1, -1, -1 },
    { "init", NULL, 0x0, -1, -1, -1, -1, -1, -1 },
  };
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxFunctionsFunc1:withRxScheduler:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "callWithId:", "LRxObservable;", 0x1, 2, 3, -1, 4, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:", "LNSException;", 0x1, 0, 1, -1, 2, -1, -1 },
    { "init", NULL, 0x0, -1, -1, -1, -1, -1, -1 },
  };
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "call", "LRxObservablesConnectableObservable;", 0x1, -1, -1, -1, 2, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const J2ObjcClassInfo _RxInternalUtilInternalObservableUtils_ReplaySupplierNoParams = { "ReplaySupplierNoParams", "rx.internal.util", ptrTable, methods, fields, 7, 0x1a, 2, 1, 4, -1, -1, 5, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxObservable:withInt:", NULL, 0x2, -1, 0, -1, 1, -1, -1 },
    { "call", "LRxObservablesConnectableObservable;", 0x1, -1, -1, -1, 2, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "source_", "LRxObservable;", .constantValue.asLong = 0, 0x12, -1, -1, 3, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxObservable:withLong:withJavaUtilConcurrentTimeUnit:withRxScheduler:", NULL, 0x2, -1, 0, -1, 1, -1, -1 },
    { "call", "LRxObservablesConnectableObservable;", 0x1, -1, -1, -1, 2, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxObservable:withInt:withLong:withJavaUtilConcurrentTimeUnit:withRxScheduler:", NULL, 0x2, -1, 0, -1, 1, -1, -1 },
    { "call", "LRxObservablesConnectableObservable;", 0x1, -1, -1, -1, 2, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "time_", "J", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxFunctionsAction2:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
    { "callWithId:withId:", "LNSObject;", 0x1, 2, 3, -1, 4, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
