...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalUtilScalarSynchronousObservable_$2)
...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalUtilScalarSynchronousObservable_$2_$1)
...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalUtilScalarSynchronousObservable_$3)

J2OBJC_INITIALIZED_DEFN(RxInternalUtilScalarSynchronousObservable)

RxPluginsRxJavaObservableExecutionHook *RxInternalUtilScalarSynchronousObservable_hook;
...
+ (RxPluginsRxJavaObservableExecutionHook *)hook {
  return RxInternalUtilScalarSynchronousObservable_hook;
}

+ (void)setHook:(RxPluginsRxJavaObservableExecutionHook *)value {
  RxInternalUtilScalarSynchronousObservable_hook = value;
}

+ (jboolean)STRONG_MODE {
  return RxInternalUtilScalarSynchronousObservable_STRONG_MODE;
}
...
- (RxObservable *)scalarScheduleOnWithRxScheduler:(RxScheduler *)scheduler {
  ...
  if ([scheduler isKindOfClass:[RxInternalSchedulersEventLoopsScheduler class]]) {
    ...
    onSchedule = new_RxInternalUtilScalarSynchronousObservable_$1_initWithRxInternalSchedulersEventLoopsScheduler_(els);
  }
  else {
    onSchedule = new_RxInternalUtilScalarSynchronousObservable_$2_initWithRxScheduler_(scheduler);
  }
  return RxObservable_createWithRxObservable_OnSubscribe_(new_RxInternalUtilScalarSynchronousObservable_ScalarAsyncOnSubscribe_initWithId_withRxFunctionsFunc1_(t_, onSchedule));
}

- (RxObservable *)scalarFlatMapWithRxFunctionsFunc1:(id<RxFunctionsFunc1>)func {
  return RxObservable_createWithRxObservable_OnSubscribe_(new_RxInternalUtilScalarSynchronousObservable_$3_initWithRxInternalUtilScalarSynchronousObservable_withRxFunctionsFunc1_(self, func));
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "createProducerWithRxSubscriber:withId:", "LRxProducer;", 0x8, 0, 1, -1, 2, -1, -1 },
    { "createWithId:", "LRxInternalUtilScalarSynchronousObservable;", 0x9, 3, 4, -1, 5, -1, -1 },
    { "initWithId:", NULL, 0x4, -1, 4, -1, 6, -1, -1 },
    { "get", "LNSObject;", 0x1, -1, -1, -1, 7, -1, -1 },
    { "scalarScheduleOnWithRxScheduler:", "LRxObservable;", 0x1, 8, 9, -1, 10, -1, -1 },
    { "scalarFlatMapWithRxFunctionsFunc1:", "LRxObservable;", 0x1, 11, 12, -1, 13, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "hook", "LRxPluginsRxJavaObservableExecutionHook;", .constantValue.asLong = 0, 0x8, -1, 14, -1, -1 },
    { "STRONG_MODE", "Z", .constantValue.asLong = 0, 0x18, -1, 15, -1, -1 },
    { "t_", "LNSObject;", .constantValue.asLong = 0, 0x10, -1, -1, 16, -1 },
  };
  static const void *ptrTable[] = { "createProducer", "LRxSubscriber;LNSObject;", "<T:Ljava/lang/Object;>(Lrx/Subscriber<-TT;>;TT;)Lrx/Producer;", "create", "LNSObject;", "<T:Ljava/lang/Object;>(TT;)Lrx/internal/util/ScalarSynchronousObservable<TT;>;", "(TT;)V", "()TT;", "scalarScheduleOn", "LRxScheduler;", "(Lrx/Scheduler;)Lrx/Observable<TT;>;", "scalarFlatMap", "LRxFunctionsFunc1;", "<R:Ljava/lang/Object;>(Lrx/functions/Func1<-TT;+Lrx/Observable<+TR;>;>;)Lrx/Observable<TR;>;", &RxInternalUtilScalarSynchronousObservable_hook, &RxInternalUtilScalarSynchronousObservable_STRONG_MODE, "TT;", "LRxInternalUtilScalarSynchronousObservable_JustOnSubscribe;LRxInternalUtilScalarSynchronousObservable_ScalarAsyncOnSubscribe;LRxInternalUtilScalarSynchronousObservable_ScalarAsyncProducer;LRxInternalUtilScalarSynchronousObservable_WeakSingleProducer;", "<T:Ljava/lang/Object;>Lrx/Observable<TT;>;" };
  static const J2ObjcClassInfo _RxInternalUtilScalarSynchronousObservable = { "ScalarSynchronousObservable", "rx.internal.util", ptrTable, methods, fields, 7, 0x11, 6, 3, -1, 17, -1, 18, -1 };
  return &_RxInternalUtilScalarSynchronousObservable;
}

+ (void)initialize {
  if (self == [RxInternalUtilScalarSynchronousObservable class]) {
    RxInternalUtilScalarSynchronousObservable_hook = [((RxPluginsRxJavaPlugins *) nil_chk(RxPluginsRxJavaPlugins_getInstance())) getObservableExecutionHook];
    {
...
id<RxProducer> RxInternalUtilScalarSynchronousObservable_createProducerWithRxSubscriber_withId_(RxSubscriber *s, id v) {
  ...
  if (RxInternalUtilScalarSynchronousObservable_STRONG_MODE) {
    return new_RxInternalProducersSingleProducer_initWithRxSubscriber_withId_(s, v);
  }
  return new_RxInternalUtilScalarSynchronousObservable_WeakSingleProducer_initWithRxSubscriber_withId_(s, v);
}
...
void RxInternalUtilScalarSynchronousObservable_initWithId_(RxInternalUtilScalarSynchronousObservable *self, id t) {
  RxObservable_initWithRxObservable_OnSubscribe_(self, [((RxPluginsRxJavaObservableExecutionHook *) nil_chk(RxInternalUtilScalarSynchronousObservable_hook)) onCreateWithRxObservable_OnSubscribe:new_RxInternalUtilScalarSynchronousObservable_JustOnSubscribe_initWithId_(t)]);
  self->t_ = t;
}
...
- (void)callWithId:(RxSubscriber *)s {
  [((RxSubscriber *) nil_chk(s)) setProducerWithRxProducer:new_RxInternalUtilScalarSynchronousObservable_ScalarAsyncProducer_initWithRxSubscriber_withId_withRxFunctionsFunc1_(s, value_, onSchedule_)];
}

+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithId:withRxFunctionsFunc1:", NULL, 0x0, -1, 0, -1, 1, -1, -1 },
    { "callWithId:", "V", 0x1, 2, 3, -1, 4, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
    { "value_", "LNSObject;", .constantValue.asLong = 0, 0x10, -1, -1, 5, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithRxSubscriber:withId:withRxFunctionsFunc1:", NULL, 0x1, -1, 0, -1, 1, -1, -1 },
...
void RxInternalUtilScalarSynchronousObservable_ScalarAsyncProducer_initWithRxSubscriber_withId_withRxFunctionsFunc1_(RxInternalUtilScalarSynchronousObservable_ScalarAsyncProducer *self, RxSubscriber *actual, id value, id<RxFunctionsFunc1> onSchedule) {
  ...
  self->actual_ = actual;
  self->value_ScalarAsyncProducer_ = value;
  self->onSchedule_ = onSchedule;
}
...
- (void)requestWithLong:(jlong)n {
  ...
  if (n < 0LL) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$J", @"n >= required but it was ", n));
  }
  if (n == 0LL) {
    return;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:", "LRxSubscription;", 0x1, 0, 1, -1, -1, -1, -1 },
    { "initWithRxInternalSchedulersEventLoopsScheduler:", NULL, 0x0, -1, 2, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
- (id<RxSubscription>)callWithId:(id<RxFunctionsAction0>)a {
  ...
  (void) [((RxScheduler_Worker *) nil_chk(w)) scheduleWithRxFunctionsAction0:new_RxInternalUtilScalarSynchronousObservable_$2_$1_initWithRxFunctionsAction0_withRxScheduler_Worker_(a, w)];
  return w;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "callWithId:", "LRxSubscription;", 0x1, 0, 1, -1, -1, -1, -1 },
    { "initWithRxScheduler:", NULL, 0x0, -1, 2, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalUtilScalarSynchronousObservable_$2)
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "call", "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { "initWithRxFunctionsAction0:withRxScheduler_Worker:", NULL, 0x0, -1, 0, -1, -1, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalUtilScalarSynchronousObservable_$2_$1)
...
- (void)callWithId:(RxSubscriber *)child {
  ...
  if ([o isKindOfClass:[RxInternalUtilScalarSynchronousObservable class]]) {
    ...
    (void) [((RxObservable *) nil_chk(o)) unsafeSubscribeWithRxSubscriber:RxObserversSubscribers_wrapWithRxSubscriber_(child)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithRxInternalUtilScalarSynchronousObservable:withRxFunctionsFunc1:", NULL, 0x0, -1, 3, -1, 4, -1, -1 },
  };
  static const J2ObjcFieldInfo fields[] = {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalUtilScalarSynchronousObservable_$3)
