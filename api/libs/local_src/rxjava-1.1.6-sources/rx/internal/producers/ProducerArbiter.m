...
J2OBJC_TYPE_LITERAL_HEADER(RxInternalProducersProducerArbiter_$1)
...
+ (id<RxProducer>)NULL_PRODUCER {
  return RxInternalProducersProducerArbiter_NULL_PRODUCER;
}
...
- (void)producedWithLong:(jlong)n {
  ...
  @try {
    ...
    if (r != JavaLangLong_MAX_VALUE) {
      jlong u = r - n;
      if (u < 0) {
        @throw new_JavaLangIllegalStateException_initWithNSString_(@"more items arrived than were requested");
      }
      requested_ = u;
    }
    [self emitLoop];
...
- (void)setProducerWithRxProducer:(id<RxProducer>)newProducer {
  @synchronized(self) {
    if (emitting_) {
      missedProducer_ = newProducer == nil ? RxInternalProducersProducerArbiter_NULL_PRODUCER : newProducer;
      return;
    }
    emitting_ = true;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "producedWithLong:", "V", 0x1, 2, 1, -1, -1, -1, -1 },
    { "setProducerWithRxProducer:", "V", 0x1, 3, 4, -1, -1, -1, -1 },
    { "emitLoop", "V", 0x1, -1, -1, -1, -1, -1, -1 },
...
+ (void)initialize {
  if (self == [RxInternalProducersProducerArbiter class]) {
    RxInternalProducersProducerArbiter_NULL_PRODUCER = new_RxInternalProducersProducerArbiter_$1_init();
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxInternalProducersProducerArbiter_$1)
