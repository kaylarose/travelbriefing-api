...
/*!
 @brief Generic strategy and default implementations to deal with backpressure buffer overflows.
 */
...
/*!
 @brief Whether the Backpressure manager should attempt to drop the oldest item, or simply
...
/*!
 @brief Drop oldest items from the buffer making room for newer ones.
 */
...
/*!
 @brief Drop most recent items, but not <code>onError</code> nor unsubscribe from source
...
/*!
 @brief <code>onError</code> a MissingBackpressureException and unsubscribe from source.
 */
